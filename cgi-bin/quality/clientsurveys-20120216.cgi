...
my $search_dateafter = "";
	...
	my $search_dateafter_label = &commoncode::date2standard($search_dateafter); # pretty date format for showing on screen
...
EOM
	...
	my $command = "select unique_id, title, title2, profile1, profile2, profile3, profile4, profile5, profile6, profile7, profile8 from sedlcatalog";
	my $dbh = DBI->connect($dsn, "corpuser", "public");
	my $sth = $dbh->prepare($command) or die "Couldn't prepare statement: " . $dbh->errstr;
	$sth->execute;
		while (my @arr = $sth->fetchrow) {
			my ($unique_id, $title, $title2, $profile1, $profile2, $profile3, $profile4, $profile5, $profile6, $profile7, $profile8) = @arr;
...
<tr><td valign="top" width="50%">
		<h2>Surveys by Quarter and Month</h2>
...
EOM
    foreach my $mnth (reverse (sort (keys(%summary_bymonth)))) {
		if ($summary_bymonth{$mnth} != 0) {
			...
			print "<option value=\"mnth\">$summary_bymonth{$mnth}</a> responses in $month_label</option>";
		}
    } # END FOREACH
...
<tr><td valign="top" width="50%">
		<h2>Surveys by Author</h2>
		<img src="/staff/quality/images/byauthor.jpg" alt="View Survey Responses by Document Author"><br>
		<div style="text-align:center;margin-top:6px;">
		<form action="clientsurveys.cgi" method="GET">
			<select name="search_author" id="search_author">
			<option>Select a resource author</option>
EOM
...
print<<EOM;
	...
	<td valign="top" width="50%">
		<h2>Surveys by Other Criteria</h2>
		<p>Unused at this time</p>
		<p>
		TO DO LIST<br>
		 - Add list of surveys by user's assignment to be that product's monitor and by month<br>
		 - Add search by client e-mail<br>
		 - Add summary report of number of clients who have provided survey feedback and frequency of # of docs each
		 </p>
...
<TR><TD VALIGN="TOP"><IMG SRC="images/new.gif" ALT="Status" class="noBorder"></TD><TD>New entry - Survey not sent yet</TD></TR>
<TR><TD VALIGN="TOP"><IMG SRC="images/surveysent.gif" ALT="Status" class="noBorder"></TD><TD>Survey Sent</TD></TR>
<TR><TD VALIGN="TOP"><IMG SRC="images/surveyreceived.gif" ALT="Status" class="noBorder"></TD><TD>Survey filled out - click individual checkmarks next to an entry below to view data</TD></TR>
<TR><TD VALIGN="TOP"><IMG SRC="images/surveynotsent.gif" ALT="Status" class="noBorder"></TD><TD>Survey will never be sent - Document was not in SEDL product catalog at time of survey</TD></TR>
<TR><TD VALIGN="TOP"><IMG SRC="images/surveybounced.gif" ALT="Status" class="noBorder"></TD><TD>User e-mail bounced/invalid</TD></TR>
</TABLE>
<P>
EOM
	...
	my $command = "select clientsurvey.recordid, clientsurvey.surveysent, clientsurvey.surveysenttwice, clientsurvey.surveyreceived, clientsurvey.email, clientsurvey.date, clientsurvey.documenturl, clientsurvey.documentid, clientsurvey.documentgroup, clientsurvey.request_followup, clientsurvey.permission_use_comments, clientsurvey.staff_comments,
		...
		$command .= " clientsurvey.date > '$search_dateafter'" if ($search_dateafter ne '');
...
#print "<p class=\"info\">MATCHES: $num_matches</p>";
	...
	while (my @arr = $sth->fetchrow) {
		...
		my $image = "";
		$image ="<a href=\"/survey/pubs.cgi?e=$email&id=$recordid\"><IMG SRC=\"images/new.gif\" ALT=\"Status\" class=\"noBorder\"></a>" if $surveysent eq 'no';
		...
		if ($documenturl ne $lastdocumenturl) {
			if ($lastdocumenturl eq '') {
				...
				<TR><TD colspan=\"5\" class=\"small\"><em>$title_label</em><br>
						$documenturl<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(view <a href=\"/staff/quality/clientsurveys.cgi?location=summary_responses_singledoc&amp;showdocid=$documentid&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year&amp;summarysite=$summarysite&amp;show_followuprequests=$show_followuprequests\">combined survey results</a>)</TD>
			...
			if ($lastdocumenturl ne '') {
				print "</TABLE><br><TABLE WIDTH=\"100%\" BORDER=\"1\" CELLSPACING=\"0\" CELLPADDING=\"2\">
						<TR><TD colspan=\"5\" class=small><em>$title_label</em><br>$documenturl<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(view <a href=\"/staff/quality/clientsurveys.cgi?location=summary_responses_singledoc&amp;showdocid=$documentid&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year&amp;summarysite=$summarysite&amp;show_followuprequests=$show_followuprequests\">combined survey results</a>)</TD>
							<TD class=\"small\">Did survey<br>contain a<br>request for<br>follow-up?</TD>
							<TD class=\"small\">Are there<br>SEDL staff<br>post-survey<br>comments?</TD>
							<TD class=\"small\">User gave<br>permission<br>to use<br>comments<br></TD></TR>\n";
			} # END IF
...
my $search_dateafter_pretty = $search_dateafter;
   $search_dateafter_pretty = &commoncode::date2standard($search_dateafter);
...
<TR><TD style="text-align:center;">\#</TD>
	...
	<TD style="text-align:center;">Surveys Sent, Rceived, and Response Ratio</TD>
...
EOM
	...
	## START: QUERY PRODUCT CATALOG FOR PRODUCTS AND PRINT TO SCREEN
		## ALLOW SEARCH BY PRODUCT
		## ALLOW SEARCH BY SUBJECT (DONE - 2/15/2012)
		## ALLOW SEARCH BY DATE
		## ALLOW SEARCH BY AUTHOR (DONE 2/15/2012)

		################################
		## START: SHOW SEARCH RESULTS
		################################
		##		LINK TO LIST OF INDIVIDUAL SURVEYS
		##		LINK TO COMBINED RESULTS
		################################
		## END: SHOW SEARCH RESULTS
		################################
	## END: QUERY PRODUCT CATALOG FOR PRODUCTS AND PRINT TO SCREEN
	...
	my $command = "select sedlcatalog.title, sedlcatalog.title2, 
		...
		$command .= " AND clientsurvey.date > '$search_dateafter'" if ($search_dateafter ne '');
		$command .= " AND clientsurvey.documentgroup LIKE '$search_category'" if ($search_category ne '');
...
<TR><TD VALIGN="TOP">$counter_uniquepubs</TD>
	...
	<TD VALIGN="TOP"><TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" WIDTH="100%">
					<TR><TD VALIGN="TOP"><em>Sent:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><a href="/staff/quality/clientsurveys.cgi?location=listsurveys&showdocid=$lastdocumentid&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests">$countsentnobounce</a></TD></TR>
...
print<<EOM;
		...
		<TR><TD VALIGN="TOP"><em>Requests:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><a href="clientsurveys.cgi?location=listsurveys&showdocid=$lastdocumentid&show_followuprequests=yes&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year\">$count_req_followup</a></TD></TR>
...
print<<EOM;
<a href="clientsurveys.cgi?location=listsurveys&showdocid=$lastdocumentid&show_usecomments=yes">$count_perm_use_comments</a>
EOM
				} else {
...
print<<EOM;
<a href=\"/staff/quality/clientsurveys.cgi?location=summary_responses_singledoc&showdocid=$lastdocumentid&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests\">combined<br>results</a>
<br>
<br>
<a href="/staff/quality/clientsurveys.cgi?location=listsurveys&showdocid=$lastdocumentid&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests&show_responses_only=yes&show_address=$show_address">$countreplied individual<br>survey$s</a></TD>
EOM
				} else {
	print "N/A";
				}
...
EOM
				if ($count_perm_use_comments ne '0') {
print<<EOM;
<A HREF="clientsurveys.cgi?location=listsurveys&showdocid=$lastdocumentid&show_usecomments=yes&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">$count_perm_use_comments</A>
EOM
				} else {
					print "$count_perm_use_comments";
				}
...
<TR><TD VALIGN="TOP">$counter_uniquepubs</TD>
	...
	<TD VALIGN="TOP"><TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" WIDTH="100%">
					<TR><TD VALIGN="TOP"><em>Sent:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><a href="/staff/quality/clientsurveys.cgi?location=listsurveys&showdocid=$css_summarytype_id&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests">$css_count_sentvalid</a></TD></TR>
...
print<<EOM;
		<TABLE CELLPADDING="1" CELLSPACING="0" WIDTH="100%">
		<TR><TD VALIGN="TOP"><em>Requests:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><a href="clientsurveys.cgi?location=listsurveys&showdocid=$css_summarytype_id&show_followuprequests=yes&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year\">$css_followups_req</a></TD></TR>
...
print<<EOM;
<a href=\"/staff/quality/clientsurveys.cgi?location=summary_responses_singledoc&showdocid=$css_summarytype_id&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests\">combined<br>results</a>
<br>
<br>
<a href="/staff/quality/clientsurveys.cgi?location=listsurveys&showdocid=$css_summarytype_id&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests&show_responses_only=yes&show_address=$show_address">$css_count_received individual<br>survey$s</a></TD>
EOM
				} else {
	print "N/A";
				}
...
<P>
<strong>Q8: Please tell us why you would or would not recommend this document to others.</strong><br>
<em><span style="color:#ff0000;">$q6a</span></em>
EOM
if ($q6a ne '') {
print<<EOM;
...
<h2>View/Add to the list of PDF documents that we don't want to send surveys to</h2>
<p>
