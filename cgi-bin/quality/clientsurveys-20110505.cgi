...
<TR><TD VALIGN=TOP>
	...
	<TD VALIGN=TOP NOWRAP>
		...
		- <A HREF="clientsurveys9.cgi?location=summary_countdate">summary: surveys by date and department</A><BR>
		- <A HREF="clientsurveys9.cgi?location=listdocumentsbytitle">list documents by title</A> (catalog items only)<BR>
		- <A HREF="clientsurveys9.cgi?location=maintenance">maintenance menu</A><BR>
		- <A HREF="clientsurveys9.cgi?location=datadump">download data to a file</A>
	</TD></TR>
</TABLE>
...
<TR><TD VALIGN=TOP>
	...
	<TD VALIGN=TOP NOWRAP>
		<strong>Navigation options:</strong><BR>
		- <A HREF="clientsurveys9.cgi?location=about">about the PDF Client Surveys</A><BR>
		- <FONT COLOR=RED><em>summary: surveys by date and department</em></FONT><BR>
		- <A HREF="clientsurveys9.cgi?location=listdocumentsbytitle">list documents by title</A> (catalog items only)<BR>
		- <A HREF="clientsurveys9.cgi?location=datadump">download data to a file</A>
	</TD></TR>
</TABLE>
<form action="clientsurveys9.cgi" method=POST>
...
#print<<EOM;
#</OL>
#	<A HREF="clientsurveys9.cgi?location=listdocuments&showpdf=$documenturl" target=viewlist>
...
<TR><TD BGCOLOR="#EBEBEB"><em>Summary Type</em></TD>
	...
	<TR><TD># Documents Surveyed</TD><TD><A HREF="/staff/quality/clientsurveys9.cgi?location=listdocumentsbytitle&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_address=$show_address">$count_unique_docs</A> (click for a list of document titles and survey stats)</TD></TR>
	<TR><TD># Survey Invitations Sent</TD><TD><A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_address=$show_address">$countsent</A></TD></TR>
	<TR><TD># Valid Sendings</TD><TD>$countsentnobounce  ($countbounced bounced e-mails not included)</TD></TR>
	<TR><TD># Survey Responses Received</TD><TD><A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_responses_only=yes&show_address=$show_address">$countreplied</A></TD></TR>
	<TR><TD>Response Ratio</TD><TD>$ratio\% ($countreplied\/$countsentnobounce)</TD></TR>
	<TR><TD># followup requests</TD><TD><A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=yes&show_address=$show_address">$count_req_followup</A></TD></TR>
	<TR><TD># staff followups recorded</TD><TD>$count_staff_followup</TD></TR>
	<TR><TD># permission to use comments</TD><TD><A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_usecomments=yes&show_address=$show_address">$count_perm_use_comments</A></TD></TR>
...
<TR><TD>AFTERSCHOOL</TD>
	...
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=afterschool&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=afterschool&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
<TR><TD>LOTECED</TD>
	<TD ALIGN="RIGHT">$count_byproject{'rcvd_loteced'} / $count_byproject{'loteced'}</TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=loteced&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=loteced&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
<TR><TD>Reading Resources</TD>
	<TD ALIGN="RIGHT">$count_byproject{'rcvd_reading'} / $count_byproject{'reading'}</TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=reading&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=reading&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
<TR><TD>National Center for Family<BR>and Community Connections site</TD>
	...
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=connections&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=connections&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
<TR><TD>SCIMAST</TD>
	<TD ALIGN="RIGHT">$count_byproject{'rcvd_scimast'} / $count_byproject{'scimast'}</TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=scimast&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=scimast&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
...
<TR><TD BGCOLOR="#EBEBEB">All PDFs on www.sedl.org</TD>
	...
	<TD BGCOLOR="#EBEBEB"><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=sedl&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD BGCOLOR="#EBEBEB"><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=sedl&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
<TR><TD BGCOLOR="#EBEBEB">All PDFs on any Web server run by SEDL</TD>
	<TD BGCOLOR="#EBEBEB" ALIGN="RIGHT">$num_matches_ubertotal</TD>
	<TD BGCOLOR="#EBEBEB"><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&amp;summarysite=all&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">Catalog items</A></TD>
	<TD BGCOLOR="#EBEBEB"><A HREF="clientsurveys9.cgi?location=listdocumentsbyurl&amp;summarysite=%&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">any PDF</A></TD></TR>
</TABLE>
<P>
...
<TR><TD><em>Classroom Compass</em></TD>
	...
	<TD COLSPAN=2><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&summarysite=compass&search_date=$search_date&search_month=$search_month&search_year=$search_year">list this serial pub's editions</A></TD></TR>
<TR><TD><em>Insights into Education Policy...</em></TD>
	<TD ALIGN="RIGHT">$count_byproject{'insights'}</TD>
	<TD COLSPAN=2><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&summarysite=insights&search_date=$search_date&search_month=$search_month&search_year=$search_year">list this serial pub's editions</A></TD></TR>
<TR><TD><em>Issues about Change...</em></TD>
	<TD ALIGN="RIGHT">$count_byproject{'change'}</TD>
	<TD COLSPAN=2><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&summarysite=change&search_date=$search_date&search_month=$search_month&search_year=$search_year">list this serial pub's editions</A></TD></TR>
<TR><TD><em>SECC Rapid Responses</em></TD>
	<TD ALIGN="RIGHT">$count_byproject{'rapidresponses'}</TD>
	<TD COLSPAN=2><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&summarysite=rapidresponses&search_date=$search_date&search_month=$search_month&search_year=$search_year">list this serial pub's editions</A></TD></TR>
<TR><TD><em>SEDL Letter</em></TD>
	<TD ALIGN="RIGHT">$count_byproject{'sedlletter'}</TD>
	<TD COLSPAN=2><A HREF="clientsurveys9.cgi?location=listdocumentsbytitle&summarysite=sedlletter&search_date=$search_date&search_month=$search_month&search_year=$search_year">list this serial pub's editions</A></TD></TR>
</TABLE>
<P>
...
print<<EOM;
	...
	<A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$documenturl" target=viewlist>
	<IMG SRC=\"images/surveyview.gif\" ALT="View list of e-mail addresses" ALIGN=RIGHT BORDER=0></A>
	<strong class=small><FONT COLOR=996600>$documenturl</FONT></strong><BR>
	<SPAN class=small>($documenttitle)</SPAN>
<OL>
...
#print "<p class=\"info\">COMMAND: $command<BR><BR>MATCHES: $num_matches</p>";
	while (my @arr = $sth->fetchrow) {
		...
		$text_q7a .= "<LI>$q7a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q7a ne ''); 
		$text_q2b .= "<LI>$q2b [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q2b ne ''); 
		$text_q3e .= "<LI>$q3e [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q3e ne ''); 
		$text_q8a .= "<LI>$q8a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q8a ne ''); 
		$text_q9a .= "<LI>$q9a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q9a ne ''); 
		$text_q4a .= "<LI>$q4a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q4a ne ''); 
		$text_q6a .= "<LI>$permission_flag_bolding$q6a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]$permission_flag" if ($q6a ne ''); 
		$text_q5a .= "<LI>$q5a [<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><FONT COLOR=\"#999999\">$recordid</FONT></A>]" if ($q5a ne ''); 
...
<BR>
<BR>
The survey responses included <A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$showpdf&show_followuprequests=yes">$total_request_followup requests for followup contact</A>\.
EOM
...
<TR><TD class=small VALIGN=TOP>$counter_uniquepubs</TD>
	<TD class=small><A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl\">$add_doctitle $lastdocumenturl_label</TD>
...
print<<EOM;
<TR><TD class=small VALIGN=TOP>$counter_uniquepubs</TD>
	<TD class=small><A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl\">$add_doctitle $lastdocumenturl_label</A></TD>
	<TD class=small>$countnotsent</TD>
	<TD class=small>$countsentnobounce</TD>
	<TD class=small>$countreplied</TD>
	<TD class=small>$ratio\%</TD>
...
EOM
	if ($summarysite ne '') {
		print "		- <A HREF=\"clientsurveys9.cgi?location=listdocumentsbytitle\">list documents by title</A> (catalog items only)<BR>";
	} else {
...
<TR><TD VALIGN=TOP>$counter_uniquepubs</TD>
	...
	<TD VALIGN=TOP><TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" WIDTH="100%">
					<TR><TD VALIGN="TOP"><em>Sent:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests">$countsentnobounce</A></TD></TR>
...
print<<EOM;
		...
		<TR><TD VALIGN=TOP><em>Requests:</em></TD><TD VALIGN="TOP" ALIGN="RIGHT"><A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl&show_followuprequests=yes&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year\">$count_req_followup</A></TD></TR>
...
print<<EOM;
<A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl&show_usecomments=yes">$count_perm_use_comments</A>
EOM
				} else {
...
print<<EOM;
<A HREF=\"/staff/quality/clientsurveys9.cgi?location=summary_responses_singledoc&showpdf=$lastdocumenturl&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests\">combined<BR>results</A>
<BR>
<BR>
<A HREF="/staff/quality/clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests&show_responses_only=yes&show_address=$show_address">$countreplied individual<BR>survey$s</A></TD>
EOM
} else {
	print "N/A";
}
...
EOM
				if ($count_perm_use_comments ne '0') {
print<<EOM;
<A HREF="clientsurveys9.cgi?location=listsurveys&showpdf=$lastdocumenturl&show_usecomments=yes&amp;search_date=$search_date&amp;search_month=$search_month&amp;search_year=$search_year">$count_perm_use_comments</A>
EOM
				} else {
					print "$count_perm_use_comments";
				}
...
#print "<P>COMMAND: $command<P>";
	...
	while (my @arr = $sth->fetchrow) {
		...
		$image ="<A HREF=\"/staff/quality/clientsurveys9.cgi?location=showdata&surveyid=$recordid\" TARGET=TOP><IMG SRC=\"images/surveyreceived.gif\" ALT=\"Status\" BORDER=0> view this survey</A>" if (($surveyreceived ne '') &&($surveyreceived ne '0000-00-00'));
		if ($documenturl ne $lastdocumenturl) {
			if ($lastdocumenturl eq '') {
				print "<BR><TABLE WIDTH=100% BORDER=1 CELLSPACING=0 CELLPADDING=2>
				<TR><TD colspan=5 class=small><em>$title_label</em><BR>$documenturl<BR> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(view <A HREF=\"/staff/quality/clientsurveys9.cgi?location=summary_responses_singledoc&showpdf=$documenturl&search_date=$search_date&search_month=$search_month&search_year=$search_year&summarysite=$summarysite&show_followuprequests=$show_followuprequests\">combined survey results</A>)</TD>
...
<P>
<form method="POST" action="clientsurveys9.cgi">
	<UL>
