...
#	$cleanitem =~ s/ñ/&ntilde\;/g; # COMMENTED OUT BECAUSE IT IS SUBSTITUTING FOR THE ndash
	$cleanitem =~ s/Ò/&Ograve\;/g;
	$cleanitem =~ s/ò/&ograve\;/g;
	$cleanitem =~ s/Ó/&Oacute\;/g;
#	$cleanitem =~ s/ó/&oacute\;/g; # COMMENTED OUT BECAUSE IT IS SUBSTITUTING FOR THE mdash
