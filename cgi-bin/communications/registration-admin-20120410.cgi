...
print<<EOM;
<h1 style="margin-top:0;">Cmapaign Manager Temporarily Closed</h1>
EOM
...
EOM
close(NOTIFY);
	print "<P><FONT COLOR=GREEN>Your request was sent to Brian by e-mail.  Brian will contact you when the address is set up and ready to use.</FONT>";
	$location = "show_events";
...
my @templates = ('', 'secc', 'sedl', 'txcc', 'pirc');
...
<TR><TD VALIGN="TOP" WIDTH="50%"><strong>Event Name (part 1)</strong> <FONT COLOR=RED>*</FONT></TD>
	<TD WIDTH="50%"><textarea name="new_event_name" rows="7" cols="70">$event_name</textarea></TD></TR>
<TR><TD VALIGN="TOP"><strong>Event Name (part 2)</strong><BR>
		<em>this part will be italicized on form</em></TD>
	<TD VALIGN="TOP"><textarea name="new_event_name_italics" rows="7" cols="70">$event_name_italics</textarea></TD></TR>
<TR><TD VALIGN="TOP"><strong>Short name for event</strong> <FONT COLOR=RED>*</FONT><BR>
		used in sentences on the registration form<BR>
		(ex: event, conference, seminar, fall forum, professional development sessions)</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_name_short" size="30" VALUE="$event_name_short"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Date of the event</strong> <FONT COLOR=RED>*</FONT><BR>
		(ex format: January 23-24, 2005)</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_date_label" size="70" VALUE="$event_date_label"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Event Location</strong><BR>
		(ex: Austin, TX)</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_location" size="30" VALUE="$event_location"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Event Accommodations</strong></TD>
	<TD VALIGN="TOP"><textarea name="new_event_accomodations" rows="12" cols="70">$event_accomodations</textarea></TD></TR>
<TR><TD VALIGN="TOP"><strong>URL for the agenda</strong><BR>
		or other supporting document for this event</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_agenda_link" size="50" VALUE="$event_agenda_link"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Text for the link</strong> to the above online document</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_agenda_link_text" size="30" VALUE="$event_agenda_link_text"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Event Registration FINAL Deadline</strong> <FONT COLOR=RED>*</FONT></TD>
	<TD VALIGN="TOP">
EOM
...
<TR><TD COLSPAN=2 BGCOLOR="#FFFFFF"><BR><H3>Costs, Early-bird Price Breaks, and Early-bird Deadlines (if any)</H3>
	<em>Note: If you are allowing participants to pay using their VISA or MasterCard credit card, 
		please let <A HREF="mailto:laura.shankland\@sedl.org?subject=SEDL will be allowing online credit card payment for an upcoming event&body=Dear Laura,">Laura Shankland</A> in Communications knows that she should be expecting
...
<TR><TD VALIGN="TOP"><strong>Event payment Instructions</strong> <FONT COLOR=RED>*</FONT><BR>
		(ex: Laura Shankland at SEDL, 4700 Mueller Blvd., Austin, TX 78723 Tel: 800-476-6861 E-mail: services\@sedl.org Fax: 512-476-2286. Please include a copy of this registration form if you are mailing or faxing your purchase order or payment.)</TD>
...
<TR><TD VALIGN="TOP"><strong>Prompt user for Afterschool participant data</strong><BR>Program name, students served, program administered, years operating, grade level, locale.</TD>
	<TD VALIGN="TOP"><BR>
EOM
...
<TR><TD VALIGN="TOP"><strong>Contact Name</strong> <FONT COLOR=RED>*</FONT><BR>
		Confirmation e-mails are sent <strong>from</strong> this name.</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_contact_name" size="50" VALUE="$event_contact_name"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Contact E-mail</strong> <FONT COLOR=RED>*</FONT><BR>
		Confirmation e-mails are sent <strong>from</strong> this address.</TD>
	<TD VALIGN="TOP"><input type="text" name="new_event_contact_email" size="50" VALUE="$event_contact_email"></TD></TR>
<TR><TD VALIGN="TOP"><strong>Staff e-mails to receive e-mail registration notices</strong> <FONT COLOR=RED>*</FONT><BR>
...
## $event_prompt_address_home, $event_prompt_data_cc, $event_prompt_data_afterschool, $event_preevent, $event_preevent_name, $event_preevent_cost
...
if ($location eq 'copy_event') {
	if ($confirm_action ne 'yes') {
		...
		## SHOW FORM TO GATHER ADDITIONAL NEW DATE INFORMATION
			...
			my $command = "INSERT INTO registration_events VALUES('', '$event_name', '$event_name_italics', '$event_name_short', '$event_date_label', '$event_location', '$event_accomodations', '$event_agenda_link', '$event_agenda_link_text', '$event_discount_reg_date', '$event_cost_early_single', '$event_cost_early_multiple', '$event_cost_late_single', '$event_cost_late_multiple', '$event_cost_free', '$event_cost_table', '$event_comp_code', '$event_registration_deadline', '$event_registration_warning', '$event_cancellation_instructions', '$event_payment_instructions', '$event_text_thankyou', '$event_email_noticesto', '$event_contact_name', '$event_contact_email', '$event_allowreg_startdate', '$event_allowreg_enddate', '$event_created_on', '$event_created_by', '$event_editable_by', '$event_page_template', '$event_prompt_table', '$event_prompt_table_text', '$event_prompt_address_home', '$event_prompt_data_hotel', '$event_prompt_data_cc_affiliation', '$event_prompt_data_cc_esc', '$event_prompt_data_cc_role', '$event_prompt_data_cc_previous', '$event_prompt_data_cc_focus', '$event_prompt_data_afterschool', '$event_preevent', '$event_preevent_name', '$event_preevent_cost', '$event_max_registrants', '$event_max_reg_nextform_id', '$event_max_registrants_perform', '$event_min_registrants_perform', '$event_confirm_checkbox', '$event_prompt_session_choice', '$event_session1_title', '$event_session1_desc', '$event_session2_title', '$event_session2_desc', '$event_allow_pay_atdoor', '$event_allow_pay_atdoor_text', '$event_allow_pay_invoiceme', '$event_allow_pay_invoiceme_text', '$event_prompt_individual_org', '$event_extra_text', '$event_budgetcode')";
			my $dbh = DBI->connect($dsn, "corpuser", "public");
			my $sth = $dbh->prepare($command) or die "Couldn't prepare statement: " . $dbh->errstr;
			$sth->execute;
...
if ($location eq 'show_events') {
	...
	my $command = "SELECT * from registration_events";
		if ($admin_user ne 'yes') {
			...
			if ($show_year ne 'any') {
				$command .= " AND event_date_label LIKE '%$show_year%'";
			}
		} else {
			$command .= " WHERE event_date_label LIKE '%$show_year%'";
		}
...
EOM
	...
	## SET WARNING FOR EVENT WITH COST IF LAURA SHANKLAND IS NOT ON THE E-MAIL CC LIST
	$warning_cc_oic = "";
	if (($event_cost_free ne 'yes') && ($event_email_noticesto !~ 'shankland')) {
    	$warning_cc_oic = "<BR><FONT COLOR=RED>Warning: Your event is not free, which means credit card payments may be accepted.  However, you have not added Laura Shankland (laura.shankland\@sedl.org) to the list of staff who receive contact e-mails when registrations are received.</FONT>";
	}
...
print<<EOM;
		...
		<TR><TD nowrap>
			- Preview this <A HREF="/cgi-bin/mysql/registration/registration.cgi?eventid=$event_id&amp;show_year=$show_year">$event_page_template form</A><br>
	...
	<TD VALIGN="TOP" rowspan="2">$event_date_label<P><SPAN class=small><FONT COLOR="#999999">
...
EOM
	if (($event_discount_reg_date ne '') && ($event_discount_reg_date ne '0000-00-00')) {
		...
		print "<P>Early Reg. deadline<BR>$event_discount_reg_date";
	}
	if ($event_max_registrants ne '0') {
		print "<P>Max capacity: $event_max_registrants";
	}
	if (($event_max_registrants_perform ne '0') && ($event_max_registrants_perform ne '10')) {
		print "<P>Max per submission: $event_max_registrants_perform";
	}
	if (($event_min_registrants_perform ne '0') && ($event_min_registrants_perform ne '1')) {
		print "<P>Min per submission: $event_min_registrants_perform";
	}
	if ($event_max_reg_nextform_id ne '0') {
		print "<P>After capacity, redirect to reg. form: <A HREF=\"/cgi-bin/mysql/registration/registration.cgi?eventid=$event_max_reg_nextform_id&amp;show_year=$show_year\">$event_max_reg_nextform_id</A>";
	}
...
EOM
	...
	if ($event_contact_email eq '') {
    	print "<BR><FONT COLOR=RED>Warning: You have not specified a contact e-mail address, which is required to send the user a confirmation e-mail.</FONT>";
	} 
	if ($event_email_noticesto ne '') {
		print "<br><br>cc e-mails: $event_email_noticesto";
	} else {
		print "<br><br><font color=red>no cc e-mail specified</font>";
	}
...
<tr><td colspan="4" $row_bgcolor><span class="small">Short URL: <A HREF="http://www.sedl.org/register/event$event_id.html" target="_blank">http://www.sedl.org/register/event$event_id.html</A></span></td></tr>
EOM
			if ($event_year ne '') {
...
#my $num_matches = $sth->rows;
	...
	my $last_org_id = "";
		while (my @arr = $sth->fetchrow) {
    		...
    		$special_accomodations, $cc_job_affiliation, $cc_job_affiliation_other, $cc_esc, $cc_role, $cc_previous, $cc_focus, $hotel_arrive, $hotel_depart, $hotel_bed, $hotel_smoking, $session_number) = @arr;
...
if ($location =~ 'edit_person') {
	...
	my $view_org = ""; my $view_prefix = ""; my $view_firstname = ""; my $view_lastname = ""; my $view_title = ""; my $view_email = ""; my $view_phone = "";

	my $command = "SELECT registration_orgs.org, registration_people.prefix, registration_people.firstname, registration_people.lastname, registration_people.title, registration_people.email, registration_people.phone
		from registration_orgs, registration_people 
		WHERE registration_orgs.org_unique_id = registration_people.org_unique_id
...
#		$command .= " order by registration_people.lastname, registration_people.firstname ";
		...
		while (my @arr = $sth->fetchrow) {
    		($view_org, $view_prefix, $view_firstname, $view_lastname, $view_title, $view_email, $view_phone) = @arr;
		}	
	...
	my $command_update = "UPDATE registration_people 
					SET firstname = '$new_p_firstname', lastname = '$new_p_lastname', title = '$new_p_title', email = '$new_p_email', phone = '$new_p_phone' 
...
print<<EOM;      
<P><FORM ACTION="registration-admin.cgi" METHOD="POST">
<TABLE>
...
<TD VALIGN="TOP"><TABLE BORDER=1 CELLPADDING=1 CELLSPACING=0 WIDTH="100%">
  ...
  <INPUT TYPE="SUBMIT" VALUE="Edit">
	...
	<TR><TD VALIGN="TOP"><strong>E-mail:</strong></TD><TD>$email</TD></TR>
...
<P>
If you have an enhancement to suggest or request, please send an e-mail to Brian Litke at blitke\@sedl.org or call ext. 260.
EOM
}
################################
...
<P>
<form action="registration-admin.cgi" method="POST">
Sort records by : <select name="sortby" id="sortby">
EOM
my $counter = "0";
...
EOM
	...
	print DATA "prefix\tfirstname\tlastname\ttitle\temail\tphone";
		...
		print DATA "\treg_timestamp\treg_date\tuser_id\torg_unique_id2\tunit_cost\tpersonal_cost\tpay_type\tpay_rcvd_type\tpay_rcvd_date\tpay_rcvd_by\tpay_rcvd_notes";
		if ($this_event_prompt_session_choice eq 'yes') {
	...
	print DATA "\tspecial_accomodations\torg_unique_id\tunit_cost\ttable_cost\ttotal_cost\tcomp_code\torg\tdepartment\taddress1\taddress2\tcity\tstate\tzip\tphone\tfax\temail\tspecial_needs\tpay_how\tnumber_registrants\tregistration_event\tregistration_event_id\n";
	...
	my $last_payment_name = "";
		...
		while (my @arr = $sth->fetchrow) {
    		($org_unique_id, $unit_cost, $table_cost, $total_cost, $comp_code, $org, $org_department, $address1, $address2, $city, $state, $zip, $org_phone, $fax, $org_email, $special_needs, $pay_how, $number_registrants, $registration_timestamp, $registration_date, $registration_event, $registration_event_id, $as_program_name, $as_students_served, $as_based, $as_years_operating, $as_grade_level, $as_locale,
				...
				print DATA "\t$registration_timestamp\t$registration_date\t$personal_unique_id\t$org_unique_id2\t$unit_cost\t$personal_cost\t$pay_type\t$pay_rcvd_type\t$pay_rcvd_date\t$pay_rcvd_by\t$pay_rcvd_notes";
				if ($this_event_prompt_session_choice eq 'yes') {
					print DATA "\t$session_number";
				}
				if ($this_event_prompt_data_hotel eq 'yes') {
				...
				print DATA "\t$special_accomodations\t$org_unique_id\t$unit_cost\t$table_cost\t$total_cost\t$comp_code\t$org\t$org_department\t$address1\t$address2\t$city\t$state\t$zip\t$org_phone\t$fax\t$org_email\t$special_needs\t$pay_how\t$number_registrants\t$registration_event\t$registration_event_id\n";
...
print<<EOM;
	...
	<TR><TD VALIGN="TOP"><strong>Org. Name:</strong></TD><TD VALIGN="TOP"> <FONT COLOR=GREEN><strong>$org</strong></FONT></TD></TR>
	<TR><TD VALIGN="TOP"><strong>Department:</strong></TD><TD VALIGN="TOP"> $org_department</TD></TR>
	...
	<TR><TD VALIGN="TOP"><strong>E-mail:</strong></TD><TD VALIGN="TOP"> $org_email</TD></TR>
EOM
					if ($this_event_prompt_data_afterschool eq 'yes') {
print<<EOM;
...
print<<EOM;
	...
	<TD VALIGN="TOP" NOWRAP><DIV ALIGN=CENTER class=small>Registered 
		$number_registrants $people_label<BR>
		on $registration_date<BR>
		(click to <a href="registration-admin.cgi?location=show_people&amp;show_org=$org_unique_id&amp;eventid=$eventid&amp;show_year=$show_year">edit payment &amp; reg. details</a>)</DIV>
