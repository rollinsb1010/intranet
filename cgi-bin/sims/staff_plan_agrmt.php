...
<tr><td colspan="3">
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS - Performance Appraisal</h1><hr /></td></tr>
			
			<tr bgcolor="#e2eaa4"><td class="body"><strong><?php echo stripslashes($recordData4['c.FullName'][0]);?> - <?php echo $recordData4['c.SEDL_Unit'][0];?></strong></td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="staff_plan_agrmt.php?action=show_mine&staff_ID=<?php echo $recordData4['staff_ID'][0];?>">Show All</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			
			
			
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: If changes are needed to your planning agreement, contact your admin assistant or budget authority. | Last updated: <?php echo $recordData4['last_mod_timestamp'][0];?></p></td></tr>
...
<!--BEGIN FIRST SECTION: POSITION INFORMATION-->
							...
							<tr><td class="body" valign="top" width="100%">
										...
										<table cellspacing="0" cellpadding="5" border="0" width="100%">
											...
											<tr><td colspan="2"><hr><br>SAMPLE PAGE 1:</td></tr>
...
$search5 -> SetDBData('SIMS_2.fp7','staff');
...
$search4 -> AddDBParam('view_status','active');
//$search4 -> AddDBParam('staff_ID','==180');

$search4 -> AddSortParam('creation_timestamp','descend');
//$search4 -> AddSortParam('RecordID','descend');
...
if(strpos($recordData5['c_plan_agrmt_access_list'][0],$_SESSION['user_ID'])!== false){
$allow_admin = '1';
}
//echo '<p>$allow_admin: '.$allow_admin;
###############################
...
<tr><td colspan="3">
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong><?php echo $recordData5['c_full_name_last_first'][0];?> - <?php echo $recordData5['primary_SEDL_workgroup'][0];?></strong></td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			
			
			
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: If changes are needed to your performance appraisal documents, contact your admin assistant or budget authority.
			</p></td></tr>
...
<p class="alert_small">A new planning agreement for <?php echo $recordData5['c_full_name_first_last'][0];?> was successfully created. Click the link for this PA to edit and/or print a copy.</p>
<?php $_SESSION['new_pa_created'] = ''; } ?>

<?php if($_SESSION['new_pa_created'] == '2'){ ?>
<p class="alert_small">There was a problem creating a new planning agreement for <?php echo $recordData5['c_full_name_first_last'][0];?>. Contact <a href="mailto:sims@sedl.org">sims@sedl.org</a> for assistance (ErrorCode: <?php echo $_SESSION['new_pa_error_code'];?>).</p>
<?php $_SESSION['new_pa_created'] = ''; } ?>
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr><td valign="top">
										<table cellspacing="0" cellpadding="5" border="0" width="100%">
										<tr valign="bottom"><td align="right" nowrap><font color="666666">Name:</font></td><td width="100%"><?php echo $recordData5['c_full_name_last_first'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap><font color="666666">Status:</font></td><td nowrap><?php echo $recordData5['current_employee_status'][0];?></td></tr>
										<tr valign="bottom"><td align="right" nowrap valign="top"><font color="666666">Title:</font></td><td><?php echo $recordData5['job_title'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap><font color="666666">Unit:</font></td><td><?php echo $recordData5['primary_SEDL_workgroup'][0];?></td></tr>
										
										
										<tr valign="bottom"><td align="right" nowrap><font color="666666">E-mail:</font></td><td nowrap><?php echo $recordData5['email'][0];?></td></tr>
		
										<tr valign="bottom"><td align="right" nowrap><font color="666666">Phone Ext:</font></td><td nowrap><?php echo $recordData5['phone_ext'][0];?></td></tr>

										<tr valign="bottom"><td align="right" nowrap><font color="666666">Work Hrs/Ste#:</font></td><td nowrap><?php echo $recordData5['staff_work_hours'][0];?> / <?php echo $recordData5['suite_number'][0];?></td></tr>
		
		
										<tr valign="bottom"><td align="right" nowrap><font color="666666" nowrap>Empl. Dates:</font></td><td nowrap><?php echo $recordData5['empl_start_date'][0];?> to <?php if($recordData5['empl_end_date'][0] != ''){ echo $recordData5['empl_end_date'][0]; }else{ echo 'Current';}?></td></tr>
...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td colspan="2"><font color="666666">The following are live links to your performance appraisal documents. Click the performance period to view and/or print a formal copy 
								for your records. <p>
								<strong>FYI</strong>: The following staff have read/write access to your performance appraisal documents: <strong><?php echo $recordData5['c_plan_agrmt_access_list'][0];?></strong> - If this list is incorrect, notify <a href="mailto:sims@sedl.org">sims@sedl.org</a></font>
								
								<p style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ebebeb"><span class="tiny"><strong>NOTE</strong>: To access the performance appraisal, you must have a copy of Filemaker Pro 8+ installed on your computer and
								...
								<tr valign="top"><td align="right" nowrap><font color="666666" nowrap>Form(s):</font></td><td>
										...
										<tr bgcolor="#ebebeb"><td>Performance Period</td><td nowrap>Date Created</td></tr>
										
										<?php if($searchResult4['foundCount'] == '0'){?>
												<tr><td colspan="2" align="center">No records found.</td></tr>
										<?php }else{?>

		
											<?php foreach($searchResult4['data'] as $key => $searchData4) { ?>
													<tr><td nowrap><a href="sims_temp_launcher<?php if($allow_admin == '1'){?>_admin<?php }?>.php?object_ID=<?php echo $searchData4['RecordID'][0];?>&target=plan_agrmt&user=<?php echo $searchData4['staff::sims_user_ID'][0];?>" target="_blank"><?php echo $searchData4['Performance_Period'][0];?></a></td><td nowrap><?php echo $searchData4['creation_timestamp'][0];?></td></tr>
											<?php } ?>
<tr><td colspan="2"><span class="tiny">*If you have trouble opening these documents, contact <a href="mailto:sims@sedl.org">sims@sedl.org</a></span></td></tr>
										<?php } ?>
...
<?php if($allow_admin == '1'){ ?>
								...
								<font color="#666666"><span class="tiny"><strong>CREATING A DUPLICATE PLANNING AGREEMENT:</strong></span><br>In addition to viewing your existing planning agreements above, you can also create a new planning agreement for yourself based on your most recent PA on file. To create a new (duplicated) planning agreement, open your most recent planning agreement listed above, then select "Create Duplicate Document" from the File menu.
								<br>&nbsp;<br>
								<span class="tiny"><strong>CREATING A NEW BLANK PLANNING AGREEMENT:</strong></span><br>
								If you have no existing planning agreements or to create a new blank planning agreement for yourself, <a href="sims_new_pa_admin.php?staff_ID=<?php echo $recordData5['staff_ID'][0];?>&src=staff">click here</a>. Then view or edit the newly created PA by clicking the new link above.</font></p>
											</td></tr>
