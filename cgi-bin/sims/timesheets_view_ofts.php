...
function invalidUser() { 
	alert ("This signature box is reserved for the timesheet owner.")
	return false;
}
...
<tr><td colspan="3">
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS Timesheets: OFTS Admin</h1><hr /></td></tr>
			
			
			<?php if(($action == 'view') && ($recordData['timesheets::TimesheetSubmittedStatus'][0] != 'Approved')){ ?>
			
			<tr><td colspan="2">
				<p class="alert_small"><b>Current User: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b> - This timesheet has not been approved. | <a href="timesheets_ofts_app.php?Timesheet_ID=<?php echo $_SESSION['timesheet_ID'];?>&action=view&view_mode=print" target="_blank">Printable view: timesheet</a> | <a href="/staff/sims/timesheets_rpt_out_empl_print.php?Timesheet_ID=<?php echo $_SESSION['timesheet_ID'];?>&action=print" target="_blank">Printable view: Outside Employment form</a> | <input type=button value="Close Timesheet" onClick="history.back()"></p>
			</td></tr>
			
			<?php } elseif(($action == 'view') && ($recordData['timesheets::TimesheetSubmittedStatus'][0] == 'Approved')){ ?>
			
			<tr><td colspan="2">
				<p class="alert_small"><b>Current User: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b> - This timesheet has been approved. | <a href="timesheets_ofts_app.php?Timesheet_ID=<?php echo $_SESSION['timesheet_ID'];?>&action=view&view_mode=print" target="_blank">Printable view: timesheet</a> | <a href="/staff/sims/timesheets_rpt_out_empl_print.php?Timesheet_ID=<?php echo $_SESSION['timesheet_ID'];?>&action=print" target="_blank">Printable view: Outside Employment form</a> | <input type=button class="body" value="Close Timesheet" onClick="history.back()"></p>
			</td></tr>			
