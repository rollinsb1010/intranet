...
if($_REQUEST['action_descr'] == 'Termination'){

$newrecord -> AddDBParam('base_monthly_salary',($_REQUEST['transfer_from_actual_monthly_rate'] + $_REQUEST['transfer_from_actual_monthly_rate2'])/$_REQUEST['fte']);
$newrecord -> AddDBParam('base_annual_salary',(($_REQUEST['transfer_from_actual_monthly_rate'] + $_REQUEST['transfer_from_actual_monthly_rate2'])/$_REQUEST['fte'])*12);

}else{

$newrecord -> AddDBParam('base_monthly_salary',($_REQUEST['assign_to_actual_monthly_rate'] + $_REQUEST['assign_to_actual_monthly_rate2'])/$_REQUEST['fte']);
$newrecord -> AddDBParam('base_annual_salary',(($_REQUEST['assign_to_actual_monthly_rate'] + $_REQUEST['assign_to_actual_monthly_rate2'])/$_REQUEST['fte'])*12);
...
if($newrecordResult['errorCode'] == 0){
	...
	$newrecord -> AddDBParam('action','CREATE_PERSONNEL_ACTION');
...
'http://www.sedl.org/staff/sims/menu_personnel_actions_ba_admin.php?action=show_action&record_ID='.$newrecordData['record_ID'][0]."\n\n".
...
function checkFields() { 
	...
	// Effective Date - Month
		if (document.pa_form.action_effective_date_m.value ==""){
			alert("Please select the effective date (month).");
			document.pa_form.action_effective_date_m.focus();
			return false;	}

	// Effective Date - Day
		if (document.pa_form.action_effective_date_d.value ==""){
			alert("Please select the effective date (day).");
			document.pa_form.action_effective_date_d.focus();
			return false;	}

	// Effective Date - Year
		if (document.pa_form.action_effective_date_y.value ==""){
			alert("Please select the effective date (year).");
			document.pa_form.action_effective_date_y.focus();
			return false;	}
...
<div style="float:right"><a style="text-decoration:none;background-color:#ffffff;color:#ffffff" href="#" onclick="showdiv();"><img src="images/add_button_green_round.png" style="padding:4px" id="add_button" title="Click to assign a second position title for this staff member."></a></div>
	<strong>ASSIGN TO:</strong><br>
...
<div style="float:right"><a style="text-decoration:none;background-color:#ffffff;color:#ffffff" href="#" onclick="hidediv();"><img src="images/red_delete.png" style="padding:4px" id="hide_button" title="Click to remove the second position title for this staff member."></a></div>
...
<tr><td width="50%" style="vertical-align:text-top;padding:6px;border-top:1px solid #333333; border-right:solid 1px #333333;position:relative">
<div style="float:right"><a style="text-decoration:none;background-color:#ffffff;color:#ffffff" href="#" onclick="showdiv2();"><img src="images/add_button_green_round.png" style="padding:4px" id="add_button2" title="Click to view the second position title for this staff member."></a></div>
...
<div style="float:right"><a style="text-decoration:none;background-color:#ffffff;color:#ffffff" href="#" onclick="hidediv2();"><img src="images/red_delete.png" style="padding:4px" id="hide_button2" title="Click to hide the second position title for this staff member."></a></div>
