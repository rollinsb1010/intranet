...
<?php } elseif($action == 'new_dot') { // GET THE STAFF MEMBER'S DATES AND TIMES OF TRAVEL
...
<div class="tiny" style="float:left; margin:10px; padding-top:0px;padding-bottom:6px; border-width:0px;border-style:dotted;border-color:#0a5253"><p><strong><?php echo $_SESSION['timesheet_name'];?> (<?php echo $_SESSION['workgroup'];?>)</strong></p>
...
<div style="float:right;padding-top:10px;padding-bottom:6px; margin-right:20px"><p><a href="menu_travel.php">Cancel</a></p></div>
...
<div style="background-color:#ffffff; margin-top:0px; padding-top:15px; padding-bottom:15px; padding-right:15px; padding-left:15px; border-color:#c0c9da; border-width:1px; border-style:dotted;">
				...
				<table cellspacing="0" id="shadowbox" class="col" style="width:955px; margin:5px; border-color:#c0c9da;border-width:1px;border-style:dotted; padding:5px;">

								<tr><th colspan="2"><p style="text-align:left"><strong>1. Dates of Travel</strong>: <em>Indicate the begin and end dates for this trip.</em></p></th></tr>
								...
								<tr><th nowrap valign="top" style="text-align:right;">Requested Leave Date:</th>
								<td width="80%" class="odd">
								<select name="leave_date_requested_m" id="month">
								<option value=""></option>
								...
								<select name="leave_date_requested_d" id="day">
									<option value=""></option>
								...
								<select name="leave_date_requested_y">
								<option value=""></option>
								...
								<tr><th class="even" nowrap valign="top">Requested Return Date:</th>
								<td width="80%" class="even">
								<select name="return_date_requested_m" id="month" onchange="doWork();">
								<option value=""></option>
								...
								<select name="return_date_requested_d" id="day">
									<option value=""></option>
								...
								<select name="return_date_requested_y">
								<option value=""></option>
								...
								<tr><td style="border-bottom: solid #b6cdcf 1px">&nbsp;</td><td class="odd" style="border-bottom: solid #b6cdcf 1px"><input type="submit" name="submit" value="Continue"></td></tr>
...
<?php } elseif($action == 'new_dest') { // GET IF THE STAFF MEMBER IS TRAVELLING TO MULTIPLE DESTINATIONS
...
<div style="background-color:#ffffff; margin-top:0px; padding-top:15px; padding-bottom:15px; padding-right:15px; padding-left:15px; border-color:#c0c9da; border-width:1px; border-style:dotted;">
				...
				<table cellspacing="0" id="shadowbox" class="col" style="width:955px; margin:5px; border-color:#c0c9da;border-width:1px;border-style:dotted; padding:5px;">
								<tr><th colspan="2"><p style="text-align:left">2. Destination</strong>: <em>Will you be traveling to more than 1 destination?</em></p></th></tr>
								
								<tr>
								<td style="width:50%; padding:5px; border-bottom: solid #b6cdcf 1px">
								...
								<td style="width:50%; padding:15px; border-bottom: solid #b6cdcf 1px"><form name="travel_2" method="GET">
								<input type="hidden" name="action" value="new_st"><input type="hidden" name="num_dest" value="1">No, I will be traveling to only one destination. <input type="submit" name="submit" value="Continue">
								</td></tr>
...
<div style="background-color:#ffffff; margin-top:0px; padding-top:15px; padding-bottom:15px; padding-right:15px; padding-left:15px; border-color:#c0c9da; border-width:1px; border-style:dotted;">
				...
				<table cellspacing="0" id="shadowbox" class="col" style="width:955px; margin:5px; border-color:#c0c9da;border-width:1px;border-style:dotted; padding:5px;">
								<tr><th colspan="2"><p style="text-align:left">3. Enter Destination</strong>: <em>To what destination will you be traveling?</em></p></th></tr>
								
								<tr>
								<td style="width:50%; padding:5px; border-bottom: solid #b6cdcf 1px">
									<form name="travel_1" method="GET" onsubmit="return checkFields()">
									<input type="hidden" name="action" value="new">City/State:<input type="text" name="event_venue_city" size="15">
