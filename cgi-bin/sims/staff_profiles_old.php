...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td align="right"><font color="666666">Supervisor:</font></td><td>
									...
									<?php foreach($searchResult['data'] as $key => $searchData) { ?>
									<option value="<?php echo $searchData['sims_user_ID'][0];?>" <?php if($recordData4['immediate_supervisor_sims_user_ID'][0] == $searchData['sims_user_ID'][0]){echo 'SELECTED';}?>> <?php echo $searchData['sims_user_ID'][0];?>
									<?php } ?>
									</select>
								...
								<tr valign="middle"><td align="right"><font color="666666">cc on Lv. Approval:</font></td><td>
									...
									<?php foreach($searchResult['data'] as $key => $searchData) { ?>
									<option value="<?php echo $searchData['sims_user_ID'][0];?>" <?php if($recordData4['lv_appr_cc'][0] == $searchData['sims_user_ID'][0]){echo 'SELECTED';}?>> <?php echo $searchData['sims_user_ID'][0];?>
									<?php } ?>
									</select>
...
<!--BEGIN THIRD SECTION: SIMS/INTRANET PREFERENCES-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td align="right"><font color="666666">Pos. Descr. (PD) Admin:</font></td><td>
									...
									<?php foreach($searchResult['data'] as $key => $searchData) { ?>
									<option value="<?php echo $searchData['sims_user_ID'][0];?>" <?php if($recordData4['pos_descr_admin'][0] == $searchData['sims_user_ID'][0]){echo 'SELECTED';}?>> <?php echo $searchData['sims_user_ID'][0];?>
									<?php } ?>
									</select>
								...
								<tr valign="middle"><td align="right"><font color="666666">Plan. Agrmt. (PA) Admin:</font></td><td>
									...
									<?php foreach($searchResult['data'] as $key => $searchData) { ?>
									<option value="<?php echo $searchData['sims_user_ID'][0];?>" <?php if($recordData4['plan_agrmt_admin'][0] == $searchData['sims_user_ID'][0]){echo 'SELECTED';}?>> <?php echo $searchData['sims_user_ID'][0];?>
									<?php } ?>
									</select>
...
// GRAB COMMUNICATIONS FIELDS FOR MYSQL REPLACE INTO STATEMENT
			...
			if ($num_rows == '0') {
				...
				VALUES ('$update_row_ID', '$first_name', '$middle_initial', '$last_name', '$title', '$phone', '$sims_user_ID', '$email', '$ext', '$birthmonth', '$birthday', '$timesheet_name', '$sedl_unit', '$on_mgmt_council', '$last_updated', '$last_updated_by', '$ste_num', '$start_date_mysql', '$stafflistsorting', '$imm_spvsr', '', 'Needed', '$strong_pwd', '$empl_type', '')";
