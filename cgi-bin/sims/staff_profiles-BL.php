...
#####################################################################
$array_allstaff = file("../personnel/sedlstaff-pullmenu.txt", FILE_IGNORE_NEW_LINES);
...
// GRAB COMMUNICATIONS FIELDS FOR MYSQL REPLACE INTO STATEMENT
			...
			if ($num_rows == '0') {
				...
				VALUES ('$update_row_ID', '$first_name', '$middle_initial', '$last_name', '$title', '$phone', '$sims_user_ID', '$email', '$ext', '$birthmonth', '$birthday', '$timesheet_name', '$sedl_unit', '$on_mgmt_council', '$last_updated', '$last_updated_by', '$ste_num', '$start_date_mysql', '$stafflistsorting', '$imm_spvsr', '', 'Needed', '$strong_pwd', '$empl_type', '', '$is_bgt_auth', '$is_auth_rep')";
