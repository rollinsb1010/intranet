...
<tr><td>
			...
			<tr><td class="body" nowrap><b>Reviewer: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b></td><td align="right"><a href="menu_positions_novs.php?action=urs">Show Unsolicited Resumes</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			...
			<?php if($_SESSION['position_updated'] == '1'){ ?>
			
				<tr><td colspan="2">
					<p class="alert_small"><b>Manager: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b> - Position details have been successfully updated.</p>
				</td></tr>

			<?php $_SESSION['position_updated'] = ''; } ?>

			<?php if($_SESSION['position_updated'] == '2'){ ?>
			
				<tr><td colspan="2">
					<p class="alert_small"><b>Manager: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b> - There was a problem updating the position details. Error code: <?php echo $_SESSION['position_update_error'];?>.</p>
				</td></tr>
...
<?php if($searchResult2['foundCount'] > 0){?>
				...
				<form name="form1" method="post" action="" style="padding:0px;margin:0px">
								...
								<option value="menu_positions_novs.php?pos_id=all&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&displaynum=<?php echo $displaynum;?>"<?php if($_SESSION['position_ID'] == 'all'){echo 'selected';}?>><< SHOW ALL POSITIONS >></option>

								<?php foreach($searchResult2['data'] as $key => $searchData2) { ?>
								
									<option value="menu_positions_novs.php?pos_id=<?php echo $searchData2['position_ID'][0];?>&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&displaynum=<?php echo $displaynum;?>"<?php if($_SESSION['position_ID'] == $searchData2['position_ID'][0]){echo 'selected';}?>><?php echo $searchData2['c_position_display'][0];?></option>
...
<?php }?>
				...
				<div style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ebebeb">
				<form name="form1" method="post" action="" style="padding:0px;margin:0px">
								<span class="tiny">FILTER BY STATUS:</span> <br>
								<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
								
								<option value="menu_positions_novs.php?sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $position_ID;?>"<?php if($_SESSION['status'] == 'all'){echo 'selected';}?>><< SHOW ALL CURRENT >></option>

								<?php foreach($v1Result['valueLists']['application_status'] as $key => $value) { ?>
								
									<option value="menu_positions_novs.php?sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $position_ID;?>&status=<?php echo $value;?>"<?php if($_SESSION['status'] == $value){echo 'selected';}?>><?php echo $value;?></option>
			...
			<tr><td colspan="2">
						...
						<tr>
							<td colspan="5" class="body" bgcolor="ebebeb">Applications Pending Your Review (<?php echo $searchResult['foundCount']; ?>)</td>
						...
						<td nowrap>ID</td>
						<td nowrap><a href="menu_positions_novs.php?sortfield=positions_NOVs::c_position_display&sortorder=ascend&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Position (NOV)</a></td>
						<td nowrap><a href="menu_positions_novs.php?sortfield=resume_last_name&sortorder=ascend&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Applicant Name</a></td>
						<td nowrap><a href="menu_positions_novs.php?sortfield=resume_city&sortorder=ascend&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Applicant Location</a></td>
						<td nowrap><a href="menu_positions_novs.php?sortfield=c_nov_date_received_hr&sortorder=descend&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Application Received</a></td>
						<td nowrap><a href="menu_positions_novs.php?sortfield=c_nov_priority_rating_post_resume&sortorder=ascend&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Post-Resume</a></td>
						<td nowrap>Post-Application</td>
						<td nowrap align="right"><a href="menu_positions_novs.php?sortfield=nov_status&sortorder=descend&displaynum=<?php echo $displaynum;?>">Status</td>
						...
						<?php if($searchResult['foundCount'] > 0) { $i=1;?>
							...
							<?php foreach($searchResult['data'] as $key => $searchData) { ?>
								...
								<tr>
								<td style="vertical-align:text-top"><a href="positions_novs_ba.php?id=<?php echo $searchData['resume_ID'][0];?>&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&displaynum=<?php echo $displaynum;?>&pos_id=<?php echo $_SESSION['position_ID'];?>" name="<?php echo $searchData['resume_ID'][0];?>"><?php echo $searchData['resume_ID'][0];?></a><br><span class="tiny" style="color:#666666"><?php echo $i;?></td>
								<td style="vertical-align:text-top"><?php echo $searchData['positions_NOVs::c_position_display'][0];?><br><span class="tiny"><a href="positions_mgr_edit.php?id=<?php echo $searchData['position_ID'][0];?>">Edit position details</a></span></td>
							...
							<?php $i++;} ?>
								...
								<tr><td colspan="5" style="background-color:#fbf59a"><?php if(($searchResult['foundCount'] < 100)||($i > $searchResult['foundCount'])){/* DON'T DISPLAY ANYTHING */}else{?><a href="menu_positions_novs.php?displaynum=<?php echo $i + 12;?>&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Show more</a> | <a href="menu_positions_novs.php?displaynum=all&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Show all</a> | <?php } ?><?php if($i > 100){?><a href="menu_positions_novs.php?displaynum=<?php echo $i - 12;?>&sortfield=<?php echo $sortfield;?>&sortorder=<?php echo $sortorder;?>&pos_id=<?php echo $_SESSION['position_ID'];?>">Show less</a><?php }?></td><td colspan="3" align="right" style="background-color:#000000;text-align:center;color:#ffffff">Showing <?php if($searchResult['foundCount'] < $displaynum){echo $searchResult['foundCount'];}else{echo $displaynum;}?> records</td></tr>
...
<tr><td>
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS Resumes & Applications: Reviewer Admin</h1><hr /></td></tr>
			<tr><td class="body" nowrap><b>Reviewer: <?php echo $_SESSION['staff_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b></td><td align="right"><a href="menu_positions_novs.php">Show Applications</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			...
			<tr><td colspan="2">
						...
						<?php if($searchResult['foundCount'] > 0) {?>
							...
							<?php } ?>
								...
								<tr><td colspan="4" style="background-color:#fbf59a"><?php if($searchResult['foundCount'] < 12){/* DON'T DISPLAY ANYTHING */}else{?><a href="menu_positions_novs.php?action=urs&displaynum=<?php echo $displaynum + 12;?>">Show more</a><?php } ?><?php if($displaynum > 12){?> | <a href="menu_positions_novs.php?action=urs&displaynum=<?php echo $displaynum - 12;?>">Show less</a><?php }?></td><td align="right" style="background-color:#000000;text-align:center;color:#ffffff">Showing <?php if($searchResult['foundCount'] < $displaynum){echo $searchResult['foundCount'];}else{echo $displaynum;}?> records</td></tr>
