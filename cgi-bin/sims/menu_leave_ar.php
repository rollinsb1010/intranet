...
####################################################################
## START: FIND WORKGROUP LEAVE REQUESTS FOR THIS ADMIN ##
####################################################################
...
//$search -> AddDBParam('signer_ID_pba','=='.$_SESSION['primary_bgt_auth']); // FROM STAFF IN THIS BUDGET AUTHORITY'S WORKGROUP
$search -> AddDBParam('leave_requests_staff_byStaffID::time_leave_admin_sims_user_ID',$_SESSION['user_ID']); //FROM STAFF ASSIGNED TO THIS AUTH REP
...
##################################################################
## END: FIND WORKGROUP LEAVE REQUESTS FOR THIS ADMIN ##
##################################################################

/*
####################################################################
## START: FIND THIS BUDGET AUTHORITY'S OWN LEAVE REQUESTS ##
####################################################################
...
$search2 -> AddDBParam('signer_ID_owner','=='.$_SESSION['primary_bgt_auth']); // FROM STAFF IN THIS BUDGET AUTHORITY'S WORKGROUP
...
##################################################################
## END: FIND THIS BUDGET AUTHORITY'S OWN LEAVE REQUESTS ##
##################################################################
*/
?>
...
<html>
<head>
<title>SIMS: Workgroup Leave Requests</title>
...
<tr><td>
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS Leave Requests: Workgroup Time/Leave Admin</h1><hr /></td></tr>
			<tr><td class="body" nowrap><b>Workgroup Admin: <?php echo $_SESSION['staff_name'];?></b> | Budget Authority: <?php echo $_SESSION['primary_bgt_auth'];?> (<?php echo $_SESSION['workgroup'];?>)</td><td align="right"><a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
...
<form name="form1" method="post">			
						...
						<tr>
							<td colspan="4" class="body" bgcolor="ebebeb"><?php echo $_SESSION['workgroup'];?> Leave Requests (<?php echo $searchResult['foundCount']; ?>)</td>
							<td colspan="3" class="body" bgcolor="ebebeb" align="right">Pay Period Ending: 
								<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_1'];?>"<?php if($_SESSION['payperiod_option_1'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_1'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_2'];?>"<?php if($_SESSION['payperiod_option_2'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_2'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_3'];?>"<?php if($_SESSION['payperiod_option_3'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_3'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_4'];?>"<?php if($_SESSION['payperiod_option_4'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_4'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_5'];?>"<?php if($_SESSION['payperiod_option_5'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_5'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=<?php echo $_SESSION['payperiod_option_6'];?>"<?php if($_SESSION['payperiod_option_6'] == $_SESSION['payperiod_selected']){echo 'selected';}?>><?php echo $_SESSION['payperiod_option_6'];?></option>
									<option value="menu_leave_ar.php?view_payperiod=Other..."<?php if($_SESSION['payperiod_selected'] == 'Other...'){echo 'selected';}?>>Other...</option>
								 </select>
