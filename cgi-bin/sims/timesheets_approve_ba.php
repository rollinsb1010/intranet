...
$_SESSION['approver_ID'] = $_GET['approver_ID']; //bgt auth approving
...
####################################################
## START: UPDATE BUDGET AUTHORITY APPROVAL STATUS ##
####################################################
...
##################################################
## END: UPDATE BUDGET AUTHORITY APPROVAL STATUS ##
##################################################
include_once('timesheets_process_ba.php'); //trigger e-mail notifications
}
...
if($_SESSION['timesheet_employee_type'] == 'Exempt'){

$_SESSION['payperiod_workhrs'] = $recordData6['c_num_workhrs_exempt'][0];

} elseif(($_SESSION['employee_type'] == 'Non-exempt') && ($pay_period_end_d == '15')){

$_SESSION['payperiod_workhrs'] = $recordData6['c_num_workhrs_non_exempt_1'][0];

} elseif(($_SESSION['employee_type'] == 'Non-exempt') && ($pay_period_end_d != '15')){

$_SESSION['payperiod_workhrs'] = $recordData6['c_num_workhrs_non_exempt_2'][0];
...
<tr><td colspan="3">
			...
			<?php if($approval_status == 'approved'){ ?>
				...
				<tr><td colspan="2"><p class="alert_small"><b>Budget Authority (<?php echo $_SESSION['Signer_ID_bgt_auth_'];?>)</b> - You have successfully approved this timesheet. <img src="/staff/sims/images/green_check.png"></p></td></tr>
			
			<?php } elseif ($_SESSION['Signer_status_bgt_auth_'] == '1'){ ?>
			
				<tr><td colspan="2"><p class="alert_small"><b>Budget Authority (<?php echo $_SESSION['Signer_ID_bgt_auth_'];?>)</b> - You have already approved this timesheet.</p></td></tr>
			
			<?php } else { ?>
			
				<tr><td colspan="2"><p class="alert_small"><b>Budget Authority (<?php echo $_SESSION['Signer_ID_bgt_auth_'];?>)</b> - To approve this timesheet, click the appropriate signature box below.</p></td></tr>
			...
			<tr><td class="body">&nbsp;<i>Current user: <?php echo $_SESSION['approver_ID'];?></i></td><td align="right">Timesheet ID: <?php echo $_SESSION['timesheet_ID'];?></td></tr>
