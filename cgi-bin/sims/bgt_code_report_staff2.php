...
function checkFields() { 
	...
	// Begin Date
		if (document.form2.begin_date2.value =="") {
			alert("Enter a begin date for this report.");
			document.form2.begin_date2.focus();
			return false;	}

	// End Date
		if (document.form2.end_date2.value =="") {
			alert("Enter an end date for this report.");
			document.form2.end_date2.focus();
			return false;	}
			...
			<tr><td class="body" colspan=2>
							...
							<tr><td class="body" valign="top" width="100%">
								...
								<tr><td valign="top">
											...
											<table cellspacing="0" cellpadding="5" border="0" width="100%">
											<tr><td colspan="2"><strong>Timesheet Hours Summary by Budget Code:</strong></td></tr>
											<tr><td align="right"><font color="666666">Date Range:</font></td><td>
											<form id="form2" name="form2" onsubmit="return checkFields()">
											<input type="hidden" name="action" value="run_staff_time_sum">
												<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													<td><font color="666666"><span class="tiny">BEGIN DATE</span></font><br><input type="text" name="begin_date2" size="15"></td>
													<td><font color="666666"><span class="tiny">END DATE</span></font><br><input type="text" name="end_date2" size="15"> <font color="666666">Format: MM/DD/YYYY</font></td>
												</tr>
												</table>
...
<hr>
											<table cellspacing="0" cellpadding="5" border="0" width="100%">
											<tr><td colspan="2"><strong>Budget Code Summary by Month:</strong> (Select multiple budget codes to compare time charged across this date range.)</td></tr>
											...
											<tr valign="middle"><td align="right"><font color="666666">Date Range Begin:</font></td><td>
											...
											<tr valign="middle"><td align="right"><font color="666666">Date Range End:</font></td><td>
											...
											<tr valign="middle"><td align="right"><font color="666666">Budget Code(s):</font></td><td>
...
//exit;
		...
		###################################
		$xml_header = "<chart caption='SEDL Budget Code Summary: $begin_date - $end_date' subcaption='Budget Code Summary' xAxisName='Month' yAxisName='Hours Charged' showLegend='1'>
		";
