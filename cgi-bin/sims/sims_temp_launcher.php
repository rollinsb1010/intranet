...
$newrecord -> AddDBParam('action','staff-view');
...
<html>
<head>
<meta http-equiv="refresh" content="0;url='fmp7://staff:staff@198.214.140.248/SIMS_2.fp7'" />
...
<?php
//header('Location: fmp7://staff:staff@198.214.140.248/SIMS_2.fp7');
exit;
}
...
<html>
<head>
<meta http-equiv="refresh" content="0;url='fmp7://staff2:staff@198.214.140.248/SIMS_2.fp7'" />
<script language="javascript"> 
<!-- 
setTimeout("self.close();",1000) 
//--> 
...
<?php
//header('Location: fmp7://staff2:staff@198.214.140.248/SIMS_2.fp7');
exit;
}
