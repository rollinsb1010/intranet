...
$search -> AddDBParam('leave_requests::signer_ID_owner',$_SESSION['user_ID']);
...
<tr><td colspan="3">
			...
			<tr bgcolor="#e2eaa4" valign="top"><td class="body"><strong>My Leave Calendar</strong></td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			...
			<tr bgcolor="#e2eaa4"><td class="body" colspan=2>
							...
							<tr valign="middle" height="30"><td class="body"><h1><?= date('F', mktime(0,0,0,$selected_month_m,1,$selected_month_y)).' '.$selected_month_y; ?></h1>
								...
								<?php foreach($searchResult2['data'] as $key => $searchData2) { ?>
									<option value="my_leave_calendar.php?selected_month=<?php echo $searchData2['PayPeriodEnd_exempt'][0];?>"<?php if($searchData2['PayPeriodEnd_exempt'][0] == $pay_period_end){echo ' selected';}?>><?php echo $searchData2['PayPeriodEnd_exempt'][0];?></option>
								<?php } ?>
