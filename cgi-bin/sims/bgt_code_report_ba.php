...
<?php $_SESSION['budget_code_deleted'] = ''; }?>
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong>Budget Code Summary Report: <?php echo $searchResult['foundCount'];?></strong> records found.</td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="bgt_code_report_ba.php?action=new">New Report</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
...
<?php $_SESSION['budget_code_deleted'] = ''; }?>
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong>Staff Time Summary by Budget Code: <?php echo $searchResult['foundCount'];?> records found.</td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="bgt_code_report_ba.php?action=new">New Report</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
