...
<html>
<head>
<title>SIMS - Position Descriptions</title>
...
function checkFields() { 
	...
	// First Name
		if (document.new_pd.staff_based_on.value ==""){
			alert("Please select an option from the drop-down list.");
			document.new_pd.staff_based_on.focus();
			return false;	}
}
</script>
...
<tr><td colspan="3">
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS - Position Descriptions</h1><hr /></td></tr>
			...
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: You are creating a new position description for <?php echo $recordData['c_full_name_first_last'][0];?><?php if($src != 'staff'){ ?> | <a href="menu_pos_descr_admin.php">Back to workgroup position descriptions</a><?php }?>
			</p></td></tr>
...
<!--BEGIN FIRST SECTION: STAFF PROFILE-->
							...
							<tr bgcolor="#e2eaa4"><td class="body" width="50%">&nbsp;Profile</td><td class="body" width="50%">&nbsp;Position Description(s)</td></tr>
...
<!--BEGIN SECOND SECTION: POSITION DESCRIPTION INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td colspan="2"><h2>New Position Description</h2>
								<form action="sims_new_pd_admin.php" name="new_pd" id="new_pd" onsubmit="return checkFields()">
								<input type="hidden" name="staff_ID" value="<?php echo $staff_ID;?>">
								<input type="hidden" name="target" value="pos_descr">
								<font color="#666666">You have chosen to create a new position description (PD) for SEDL staff member - <?php echo $recordData['c_full_name_first_last'][0];?> - from the 
								profile information on the left. If you would like to base <?php echo $recordData['name_first'][0];?>'s new position description on another staff member's position description, select the appropriate staff member and click the "Create Position Description" button.<p>
								Base the new PD on the most recent PD of: </font>
								...
								<tr><td colspan="2" align="right"><input type="button" value="Cancel" onClick="history.back()"><input type="submit" name="submit" value="Create Position Description"></td></tr>
								</form>
								


								<tr><td colspan="2">
								<p style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ebebeb"><span class="tiny"><strong>NOTE</strong>: If <?php echo $recordData['name_first'][0];?>'s new position description will not be based on any other staff member's most recent position description, select <strong>NEW</strong> from the drop-down list. 
								If it will be based on <?php echo $recordData['name_first'][0];?>'s own last position description, select "<?php echo $recordData['sims_user_ID'][0];?>" from the drop-down list.</span></p></td></tr>
								
								</table>
								
							</td></tr>
							
<!--END SECOND SECTION: POSITION DESCRIPTION INFORMATION-->
...
<tr><td colspan="3">
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong><?php echo stripslashes($recordData4['staff::c_full_name_last_first'][0]);?> - <?php echo $recordData4['staff::primary_SEDL_workgroup'][0];?></strong></td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			
			
			
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: This position description was last updated: <?php echo $recordData4['last_mod_timestamp'][0];?> | <a href="staff_pos_descr_admin.php?action=show_mine&staff_ID=<?php echo $recordData4['staff_ID'][0];?>">Back to PD list for <?php echo stripslashes($recordData4['staff::c_full_name_first_last'][0]);?></a></p></td></tr>
...
<!--BEGIN FIRST SECTION: POSITION INFORMATION-->
							...
							<tr><td class="body" valign="top" width="100%">
										...
										<table cellspacing="0" cellpadding="5" border="0" width="100%">
											...
											<tr><td><strong>POSITION TITLE:</strong> <?php echo $recordData4['PositionTitle'][0];?></td><td align="right"><strong>DATE PREPARED/REVISED:</strong> <?php echo $recordData4['c_date_prepared_display'][0];?></td></tr>
											<tr><td><strong>POSITION INCUMBENT:</strong> <?php echo stripslashes($recordData4['staff::c_full_name_first_last'][0]);?></td><td align="right"><strong>SEDL UNIT:</strong> <?php echo $recordData4['SEDLUnit'][0];?></td></tr>
											<tr><td><strong>REPORTS DIRECTLY TO:</strong> <?php echo stripslashes($recordData4['staff_SJ_by_imm_spvsr::c_full_name_first_last'][0]);?></td><td align="right"><strong>Position incumbent is required to supervise other staff:</strong> <?php echo $recordData4['SupervisionRequired'][0];?></td></tr>
											<tr><td><strong>TYPE OF EMPLOYMENT:</strong> <?php echo $recordData4['EmploymentType'][0];?></td><td align="right"><strong>EXEMPT STATUS:</strong> <?php echo $recordData4['ExemptStatus'][0];?></td></tr>
											<tr><td><strong>PERCENT OF TIME EMPLOYED:</strong> <?php echo $recordData4['PercentFTE'][0];?></td><td align="right"><strong>Pay Grade:</strong> <?php echo $recordData4['PayGrade'][0];?></td></tr>

											<tr><td colspan="2"><hr></td></tr>
											
											<tr><td colspan="2" valign="bottom"><strong>POSITION DIMENSIONS:</strong></td></tr>
											<tr><td colspan="2"><?php echo $recordData4['PositionDimensions'][0];?></td></tr>
		
											<tr><td colspan="2" valign="bottom"><strong>RESPONSIBILITIES:</strong></td></tr>
											<tr><td colspan="2"><?php echo $recordData4['c_responsibilities1_html'][0];?></td></tr>

											<tr><td colspan="2"><?php echo $recordData4['c_responsibilities2_html'][0];?></td></tr>

											<tr><td colspan="2"><em>* indicates an essential function of the position.</em></td></tr>

											<tr><td colspan="2" valign="bottom"><strong>ESTIMATED AMOUNT OF TRAVEL:</strong></td></tr>
											<tr><td colspan="2"><?php echo $recordData4['TravelEstimate'][0];?></td></tr>

											<tr><td colspan="2"><hr></td></tr>

											<tr><td colspan="2">
											<em>NOTE:  The above statements are intended to describe the general nature and level of the work being performed. 
											They are not intended to be construed as an exhaustive list of all the position roles and responsibilities or duties required of the staff member so classified.</em>
											</td></tr>
...
#################################
## START: FIND EMPLOYEE PDs ##
#################################
$search5 = new FX($serverIP,$webCompanionPort);
$search5-> SetDBData('SIMS_2.fp7','position_descriptions2');
...
$search5 -> AddSortParam('c_date_prepared','descend');
...
<tr><td colspan="3">
			...
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">You are viewing position descriptions for <?php echo $recordData4['c_full_name_first_last'][0];?> | <a href="menu_pos_descr_admin.php">Back to workgroup position descriptions</a></span>
			</p></td></tr>

			<tr><td class="body" colspan=2>

<!--BEGIN FIRST SECTION: STAFF PROFILE-->
<?php if($_SESSION['new_pd_created'] == '1'){ ?>
<p class="alert_small">A new position description for <?php echo $recordData4['c_full_name_first_last'][0];?> was successfully created. Click the link for the FileMaker Version of this PD to edit and/or print a copy.</p>
<?php $_SESSION['new_pd_created'] = ''; } ?>

<?php if($_SESSION['new_pd_created'] == '2'){ ?>
<p class="alert_small">There was a problem creating a new position description for <?php echo $recordData4['c_full_name_first_last'][0];?>. Contact <a href="mailto:sims@sedl.org">sims@sedl.org</a> for assistance (ErrorCode: <?php echo $_SESSION['new_pd_error_code'];?>).</p>
<?php $_SESSION['new_pd_created'] = ''; } ?>

							<table cellspacing="0" cellpadding="1" width="100%" border="1" bordercolor="#cccccc" class="sims">
							

							<tr bgcolor="#e2eaa4"><td class="body" width="50%">&nbsp;Staff Member</td><td class="body" width="50%">&nbsp;Position Description(s)</td></tr>
							
							<tr><td class="body" valign="top" width="50%">
							
								<table cellspacing="0" cellpadding="5" border="0" width="100%" style="border-width:0px">
								<tr><td valign="top" style="border-width:0px">
										<table cellspacing="0" cellpadding="5" border="0" width="100%" style="border-width:0px">
										<tr valign="bottom"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Name:</font></td><td width="100%" style="border-width:0px"><?php echo $recordData4['c_full_name_last_first'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Status:</font></td><td nowrap style="border-width:0px"><?php echo $recordData4['current_employee_status'][0];?></td></tr>
										<tr valign="bottom"><td align="right" nowrap valign="top" style="border-width:0px;background-color:#ebebeb"><font color="666666">Title:</font></td><td style="border-width:0px"><?php echo $recordData4['job_title'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Pay Grade:</font></td><td style="border-width:0px"><?php echo $recordData4['pay_grade'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Empl. Status:</font></td><td style="border-width:0px"><?php echo $recordData4['employee_type'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Unit:</font></td><td style="border-width:0px"><?php echo $recordData4['primary_SEDL_workgroup'][0];?></td></tr>
										<tr valign="middle"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Reports to:</font></td><td style="border-width:0px"><?php echo $recordData4['staff_SJ_by_imm_spvsr::c_full_name_first_last'][0];?></td></tr>
										
										<tr valign="bottom"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">E-mail:</font></td><td nowrap style="border-width:0px"><?php echo $recordData4['email'][0];?></td></tr>
		
										<tr valign="bottom"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Phone Ext:</font></td><td nowrap style="border-width:0px"><?php echo $recordData4['phone_ext'][0];?></td></tr>

										<tr valign="bottom"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666">Work Hrs/Ste#:</font></td><td nowrap style="border-width:0px"><?php echo $recordData4['staff_work_hours'][0];?> / <?php echo $recordData4['suite_number'][0];?></td></tr>
		
		
										<tr valign="bottom"><td align="right" nowrap style="border-width:0px;background-color:#ebebeb"><font color="666666" nowrap>Empl. Dates:</font></td><td nowrap style="border-width:0px"><?php echo $recordData4['empl_start_date'][0];?> to <?php if($recordData4['empl_end_date'][0] != ''){ echo $recordData4['empl_end_date'][0]; }else{ echo 'Current';}?></td></tr>
...
<!--BEGIN SECOND SECTION: POSITION DESCRIPTION INFORMATION-->
							...
							<td class="body" valign="top" width="50%" style="border-width:0px">
							
								<table cellspacing="0" cellpadding="5" border="0" width="100%">


								<tr valign="middle"><td colspan="2" style="border-width:0px"><font color="#666666">The following are live links to this <?php echo $recordData4['name_first'][0];?>'s position descriptions. Use the links in the first column - Intranet version - to view and/or print an informal copy 
								for your records. To view, edit, <strong>SIGN</strong>, and/or print a formal copy, use the links in the second column - Filemaker version. </font><p>
								<strong>FYI</strong>: The following staff have read/write access to <?php echo $recordData4['name_first'][0];?>'s position description documents: <strong><?php echo $recordData4['c_pos_descr_access_list'][0];?></strong></font><p>
								<p style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ebebeb"><span class="tiny"><strong>NOTE</strong>: To access the Filemaker version, you must have a copy of Filemaker Pro 8+ installed on your computer and
								your computer must be connected to SEDL's network or have a live VPN connection to SEDL's network.</span></p></td></tr>


								<tr valign="top"><td align="right" nowrap style="border-width:0px"><font color="666666" nowrap>Forms(s):</font></td><td style="border-width:0px">

										<table class="sims" cellpadding="4">

										<tr bgcolor="#ebebeb"><td>Intranet Version</td><td>FileMaker Version*</td></tr>
										...
										<?php foreach($searchResult5['data'] as $key => $searchData5) { ?>
													...
													<tr><td><a href="staff_pos_descr_admin.php?action=show_1&staff_ID=<?php echo $searchData5['staff_ID'][0];?>&pos_descr_ID=<?php echo $searchData5['RecordID'][0];?>"><?php echo $searchData5['c_date_prepared_display'][0];?></a></td><td><a href="sims_temp_launcher_admin.php?object_ID=<?php echo $searchData5['RecordID'][0];?>&target=pos_descr" target="_blank"><?php echo $searchData5['c_date_prepared_display'][0];?></a></td></tr>
											<?php } ?>
								...
								<tr><td colspan="2" style="border-width:0px">
								<p style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ffffff">
								<font color="#666666"><span class="tiny"><strong>CREATING A DUPLICATE POSITION DESCRIPTION:</strong></span><br>In addition to viewing the existing position description above, you can also create a new position description for <?php echo $recordData4['name_first'][0];?>. To create a new (duplicated) position description, open the most recent position description listed above, then click "Create Duplicate Document" from the File menu.
								<br>&nbsp;<br>
								<span class="tiny"><strong>CREATING A NEW BLANK POSITION DESCRIPTION:</strong></span><br>
								If there are no existing position descriptions or to create a new blank position description for <?php echo $recordData4['name_first'][0];?> <a href="sims_new_pd_admin.php?staff_ID=<?php echo $recordData4['staff_ID'][0];?>">click here</a>. Then view or edit the newly created PD by clicking the new link above.</font></p>
											</td></tr>
								
								<tr><td colspan="2" style="border-width:0px">

								<?php if(strpos($recordData4['c_plan_agrmt_access_list'][0],$_SESSION['user_ID']) !== false){?>
								<p style="padding:8px;border-width:1px;border-style:dotted;border-color:#0a5253;background-color:#ebebeb">You can also view <a href="staff_plan_agrmt_admin.php?action=show_mine&staff_ID=<?php echo $recordData4['staff_ID'][0];?>">performance appraisal documents</a> for <?php echo $recordData4['name_first'][0];?>.</p>
								<?php }?></font>
