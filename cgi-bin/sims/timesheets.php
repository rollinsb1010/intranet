...
<tr><td colspan="3">
			...
			<tr bgcolor="#a2c7ca"><td class="body"><b><?php echo $_SESSION['timesheet_name'];?> (<?php echo $_SESSION['workgroup'];?>)</b></td><td align="right">Timesheet Status: <?php echo $recordData['timesheets::TimesheetSubmittedStatus'][0];?> | Pay Period: <strong><?php echo $recordData['timesheets::PayPeriodBegin'][0];?> - <?php echo $recordData['timesheets::c_PayPeriodEnd'][0];?></strong></td></tr>
...
<!--BEGIN FIRST SECTION: REGULAR HOURS BY BUDGET CODE-->
							...
							<tr><td colspan="<?php echo $header_colspan;?>"><strong>Regular Hours by Budget Code:</strong></td></tr>
									<tr bgcolor="cccccc">
									<td class="body" nowrap>&nbsp;<strong>Budget Code</strong></td>
									...
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_01" value="<?php echo $searchData['Hrs01'][0];?>"><?php }else{ echo $searchData['Hrs01'][0]; }?></td><?php $WkHrs01_total = $WkHrs01_total + $searchData['Hrs01'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_02" value="<?php echo $searchData['Hrs02'][0];?>"><?php }else{ echo $searchData['Hrs02'][0]; }?></td><?php $WkHrs02_total = $WkHrs02_total + $searchData['Hrs02'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_03" value="<?php echo $searchData['Hrs03'][0];?>"><?php }else{ echo $searchData['Hrs03'][0]; }?></td><?php $WkHrs03_total = $WkHrs03_total + $searchData['Hrs03'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_04" value="<?php echo $searchData['Hrs04'][0];?>"><?php }else{ echo $searchData['Hrs04'][0]; }?></td><?php $WkHrs04_total = $WkHrs04_total + $searchData['Hrs04'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_05" value="<?php echo $searchData['Hrs05'][0];?>"><?php }else{ echo $searchData['Hrs05'][0]; }?></td><?php $WkHrs05_total = $WkHrs05_total + $searchData['Hrs05'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_06" value="<?php echo $searchData['Hrs06'][0];?>"><?php }else{ echo $searchData['Hrs06'][0]; }?></td><?php $WkHrs06_total = $WkHrs06_total + $searchData['Hrs06'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_07" value="<?php echo $searchData['Hrs07'][0];?>"><?php }else{ echo $searchData['Hrs07'][0]; }?></td><?php $WkHrs07_total = $WkHrs07_total + $searchData['Hrs07'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_08" value="<?php echo $searchData['Hrs08'][0];?>"><?php }else{ echo $searchData['Hrs08'][0]; }?></td><?php $WkHrs08_total = $WkHrs08_total + $searchData['Hrs08'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_09" value="<?php echo $searchData['Hrs09'][0];?>"><?php }else{ echo $searchData['Hrs09'][0]; }?></td><?php $WkHrs09_total = $WkHrs09_total + $searchData['Hrs09'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_10" value="<?php echo $searchData['Hrs10'][0];?>"><?php }else{ echo $searchData['Hrs10'][0]; }?></td><?php $WkHrs10_total = $WkHrs10_total + $searchData['Hrs10'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_11" value="<?php echo $searchData['Hrs11'][0];?>"><?php }else{ echo $searchData['Hrs11'][0]; }?></td><?php $WkHrs11_total = $WkHrs11_total + $searchData['Hrs11'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_12" value="<?php echo $searchData['Hrs12'][0];?>"><?php }else{ echo $searchData['Hrs12'][0]; }?></td><?php $WkHrs12_total = $WkHrs12_total + $searchData['Hrs12'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_13" value="<?php echo $searchData['Hrs13'][0];?>"><?php }else{ echo $searchData['Hrs13'][0]; }?></td><?php $WkHrs13_total = $WkHrs13_total + $searchData['Hrs13'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_14" value="<?php echo $searchData['Hrs14'][0];?>"><?php }else{ echo $searchData['Hrs14'][0]; }?></td><?php $WkHrs14_total = $WkHrs14_total + $searchData['Hrs14'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_15" value="<?php echo $searchData['Hrs15'][0];?>"><?php }else{ echo $searchData['Hrs15'][0]; }?></td><?php $WkHrs15_total = $WkHrs15_total + $searchData['Hrs15'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_16" value="<?php echo $searchData['Hrs16'][0];?>"><?php }else{ echo $searchData['Hrs16'][0]; }?></td><?php $WkHrs16_total = $WkHrs16_total + $searchData['Hrs16'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_17" value="<?php echo $searchData['Hrs17'][0];?>"><?php }else{ echo $searchData['Hrs17'][0]; }?></td><?php $WkHrs17_total = $WkHrs17_total + $searchData['Hrs17'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_18" value="<?php echo $searchData['Hrs18'][0];?>"><?php }else{ echo $searchData['Hrs18'][0]; }?></td><?php $WkHrs18_total = $WkHrs18_total + $searchData['Hrs18'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_19" value="<?php echo $searchData['Hrs19'][0];?>"><?php }else{ echo $searchData['Hrs19'][0]; }?></td><?php $WkHrs19_total = $WkHrs19_total + $searchData['Hrs19'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_20" value="<?php echo $searchData['Hrs20'][0];?>"><?php }else{ echo $searchData['Hrs20'][0]; }?></td><?php $WkHrs20_total = $WkHrs20_total + $searchData['Hrs20'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_21" value="<?php echo $searchData['Hrs21'][0];?>"><?php }else{ echo $searchData['Hrs21'][0]; }?></td><?php $WkHrs21_total = $WkHrs21_total + $searchData['Hrs21'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_22" value="<?php echo $searchData['Hrs22'][0];?>"><?php }else{ echo $searchData['Hrs22'][0]; }?></td><?php $WkHrs22_total = $WkHrs22_total + $searchData['Hrs22'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_23" value="<?php echo $searchData['Hrs23'][0];?>"><?php }else{ echo $searchData['Hrs23'][0]; }?></td><?php $WkHrs23_total = $WkHrs23_total + $searchData['Hrs23'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_24" value="<?php echo $searchData['Hrs24'][0];?>"><?php }else{ echo $searchData['Hrs24'][0]; }?></td><?php $WkHrs24_total = $WkHrs24_total + $searchData['Hrs24'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_25" value="<?php echo $searchData['Hrs25'][0];?>"><?php }else{ echo $searchData['Hrs25'][0]; }?></td><?php $WkHrs25_total = $WkHrs25_total + $searchData['Hrs25'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_26" value="<?php echo $searchData['Hrs26'][0];?>"><?php }else{ echo $searchData['Hrs26'][0]; }?></td><?php $WkHrs26_total = $WkHrs26_total + $searchData['Hrs26'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_27" value="<?php echo $searchData['Hrs27'][0];?>"><?php }else{ echo $searchData['Hrs27'][0]; }?></td><?php $WkHrs27_total = $WkHrs27_total + $searchData['Hrs27'][0];?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_28" value="<?php echo $searchData['Hrs28'][0];?>"><?php }else{ echo $searchData['Hrs28'][0]; }?></td><?php $WkHrs28_total = $WkHrs28_total + $searchData['Hrs28'][0];?>



									<?php if ($days_in_month > 28) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_29" value="<?php echo $searchData['Hrs29'][0];?>"><?php }else{ echo $searchData['Hrs29'][0]; }?></td><?php $WkHrs29_total = $WkHrs29_total + $searchData['Hrs29'][0];?>
									<?php } ?>
									<?php if ($days_in_month > 29) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_30" value="<?php echo $searchData['Hrs30'][0];?>"><?php }else{ echo $searchData['Hrs30'][0]; }?></td><?php $WkHrs30_total = $WkHrs30_total + $searchData['Hrs30'][0];?>
									<?php } ?>
									<?php if ($days_in_month > 30) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_31" value="<?php echo $searchData['Hrs31'][0];?>"><?php }else{ echo $searchData['Hrs31'][0]; }?></td><?php $WkHrs31_total = $WkHrs31_total + $searchData['Hrs31'][0];?>
									<?php } ?>
									<td align="center" class="body"><?php if($row_ID != $searchData['c_cwp_row_ID'][0]){?><a href="/staff/sims/timesheets.php?action=edit&Timesheet_ID=<?php echo $timesheet_ID;?>&edit_row_ID=<?php echo $searchData['c_cwp_row_ID'][0];?>">Edit</a><?php }else{?>
									<input type="hidden" name="row_type" value="reg_hrs"><input type="hidden" name="LvType" value=""><input type="submit" name="submit" value="Submit"><?php }?></td>
									<td><a href="/staff/sims/timesheet_hrs_delete.php?row_ID=<?php echo $searchData['c_cwp_row_ID'][0];?>" onclick="return confirmDelete()"><img src="/staff/sims/images/trashcan.jpg" border="0"></a></td>
									</tr>
									...
									<?php } ?>
									<td align="center" class="body"><input type="hidden" name="new_row_ID" value="<?php echo $recordData2['c_cwp_row_ID'][0];?>"><input type="hidden" name="row_type" value="reg_hrs"><input type="hidden" name="LvType" value=""><input type="submit" name="submit" value="Submit"></td>
									<td><a href="/staff/sims/timesheet_hrs_delete.php?row_ID=<?php echo $recordData2['c_cwp_row_ID'][0];?>" onclick="return confirmDelete()"><img src="/staff/sims/images/trashcan.jpg" border="0"></a></td>
									</tr>
	...
	<!--START: SUB-TOTAL REGULAR HRS-->									
									...
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs01_total;}?></td><?php $AllHrs01_total = $WkHrs01_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs02_total;}?></td><?php $AllHrs02_total = $WkHrs02_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs03_total;}?></td><?php $AllHrs03_total = $WkHrs03_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs04_total;}?></td><?php $AllHrs04_total = $WkHrs04_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs05_total;}?></td><?php $AllHrs05_total = $WkHrs05_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs06_total;}?></td><?php $AllHrs06_total = $WkHrs06_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs07_total;}?></td><?php $AllHrs07_total = $WkHrs07_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs08_total;}?></td><?php $AllHrs08_total = $WkHrs08_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs09_total;}?></td><?php $AllHrs09_total = $WkHrs09_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs10_total;}?></td><?php $AllHrs10_total = $WkHrs10_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs11_total;}?></td><?php $AllHrs11_total = $WkHrs11_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs12_total;}?></td><?php $AllHrs12_total = $WkHrs12_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs13_total;}?></td><?php $AllHrs13_total = $WkHrs13_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs14_total;}?></td><?php $AllHrs14_total = $WkHrs14_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs15_total;}?></td><?php $AllHrs15_total = $WkHrs15_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs16_total;}?></td><?php $AllHrs16_total = $WkHrs16_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs17_total;}?></td><?php $AllHrs17_total = $WkHrs17_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs18_total;}?></td><?php $AllHrs18_total = $WkHrs18_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs19_total;}?></td><?php $AllHrs19_total = $WkHrs19_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs20_total;}?></td><?php $AllHrs20_total = $WkHrs20_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs21_total;}?></td><?php $AllHrs21_total = $WkHrs21_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs22_total;}?></td><?php $AllHrs22_total = $WkHrs22_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs23_total;}?></td><?php $AllHrs23_total = $WkHrs23_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs24_total;}?></td><?php $AllHrs24_total = $WkHrs24_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs25_total;}?></td><?php $AllHrs25_total = $WkHrs25_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs26_total;}?></td><?php $AllHrs26_total = $WkHrs26_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs27_total;}?></td><?php $AllHrs27_total = $WkHrs27_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs28_total;}?></td><?php $AllHrs28_total = $WkHrs28_total;?>
									
									
									<?php if ($days_in_month > 28) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs29_total;}?></td><?php $AllHrs29_total = $WkHrs29_total;?>
									<?php } ?>
									<?php if ($days_in_month > 29) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs30_total;}?></td><?php $AllHrs30_total = $WkHrs30_total;?>
									<?php } ?>
									<?php if ($days_in_month > 30) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $WkHrs31_total;}?></td><?php $AllHrs31_total = $WkHrs31_total;?>
									<?php } ?>
									<td align="center" class="body" colspan="2">&nbsp;</td>
	...
	<!--END: SUB-TOTAL REGULAR HRS-->							
							...
							<a href="/staff/sims/timesheets.php?action=edit&new_row=wk&Timesheet_ID=<?php echo $timesheet_ID;?>">Add Regular Hours</a> | Row ID: <?php echo $new_row_ID;?><p>&nbsp;<p>
							</td></tr>
...
<!--BEGIN SECOND SECTION: PAID LEAVE HOURS-->
							...
							<tr><td colspan="<?php echo $header_colspan;?>"><strong>Paid Leave Hours</strong> | <a href="http://www.sedl.org/staff/personnel/leavereport.cgi" target="_blank">Show current leave report</a></td></tr>
							...
							<?php 
								...
								<?php }else{ ?>
									...
									<tr bgcolor="cccccc">
									<td class="body">&nbsp;<strong>Leave Type</strong></td>
...
-->									
									...
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_01" value="<?php echo $searchData3['Hrs01'][0];?>"><?php }else{ echo $searchData3['Hrs01'][0]; }?></td><?php $PdLvHrs01_total = $PdLvHrs01_total + $searchData3['Hrs01'][0];?><?php $RegHrs01_total = $PdLvHrs01_total + $WkHrs01_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_02" value="<?php echo $searchData3['Hrs02'][0];?>"><?php }else{ echo $searchData3['Hrs02'][0]; }?></td><?php $PdLvHrs02_total = $PdLvHrs02_total + $searchData3['Hrs02'][0];?><?php $RegHrs02_total = $PdLvHrs02_total + $WkHrs02_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_03" value="<?php echo $searchData3['Hrs03'][0];?>"><?php }else{ echo $searchData3['Hrs03'][0]; }?></td><?php $PdLvHrs03_total = $PdLvHrs03_total + $searchData3['Hrs03'][0];?><?php $RegHrs03_total = $PdLvHrs03_total + $WkHrs03_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_04" value="<?php echo $searchData3['Hrs04'][0];?>"><?php }else{ echo $searchData3['Hrs04'][0]; }?></td><?php $PdLvHrs04_total = $PdLvHrs04_total + $searchData3['Hrs04'][0];?><?php $RegHrs04_total = $PdLvHrs04_total + $WkHrs04_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_05" value="<?php echo $searchData3['Hrs05'][0];?>"><?php }else{ echo $searchData3['Hrs05'][0]; }?></td><?php $PdLvHrs05_total = $PdLvHrs05_total + $searchData3['Hrs05'][0];?><?php $RegHrs05_total = $PdLvHrs05_total + $WkHrs05_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_06" value="<?php echo $searchData3['Hrs06'][0];?>"><?php }else{ echo $searchData3['Hrs06'][0]; }?></td><?php $PdLvHrs06_total = $PdLvHrs06_total + $searchData3['Hrs06'][0];?><?php $RegHrs06_total = $PdLvHrs06_total + $WkHrs06_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_07" value="<?php echo $searchData3['Hrs07'][0];?>"><?php }else{ echo $searchData3['Hrs07'][0]; }?></td><?php $PdLvHrs07_total = $PdLvHrs07_total + $searchData3['Hrs07'][0];?><?php $RegHrs07_total = $PdLvHrs07_total + $WkHrs07_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_08" value="<?php echo $searchData3['Hrs08'][0];?>"><?php }else{ echo $searchData3['Hrs08'][0]; }?></td><?php $PdLvHrs08_total = $PdLvHrs08_total + $searchData3['Hrs08'][0];?><?php $RegHrs08_total = $PdLvHrs08_total + $WkHrs08_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_09" value="<?php echo $searchData3['Hrs09'][0];?>"><?php }else{ echo $searchData3['Hrs09'][0]; }?></td><?php $PdLvHrs09_total = $PdLvHrs09_total + $searchData3['Hrs09'][0];?><?php $RegHrs09_total = $PdLvHrs09_total + $WkHrs09_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_10" value="<?php echo $searchData3['Hrs10'][0];?>"><?php }else{ echo $searchData3['Hrs10'][0]; }?></td><?php $PdLvHrs10_total = $PdLvHrs10_total + $searchData3['Hrs10'][0];?><?php $RegHrs10_total = $PdLvHrs10_total + $WkHrs10_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_11" value="<?php echo $searchData3['Hrs11'][0];?>"><?php }else{ echo $searchData3['Hrs11'][0]; }?></td><?php $PdLvHrs11_total = $PdLvHrs11_total + $searchData3['Hrs11'][0];?><?php $RegHrs11_total = $PdLvHrs11_total + $WkHrs11_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_12" value="<?php echo $searchData3['Hrs12'][0];?>"><?php }else{ echo $searchData3['Hrs12'][0]; }?></td><?php $PdLvHrs12_total = $PdLvHrs12_total + $searchData3['Hrs12'][0];?><?php $RegHrs12_total = $PdLvHrs12_total + $WkHrs12_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_13" value="<?php echo $searchData3['Hrs13'][0];?>"><?php }else{ echo $searchData3['Hrs13'][0]; }?></td><?php $PdLvHrs13_total = $PdLvHrs13_total + $searchData3['Hrs13'][0];?><?php $RegHrs13_total = $PdLvHrs13_total + $WkHrs13_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_14" value="<?php echo $searchData3['Hrs14'][0];?>"><?php }else{ echo $searchData3['Hrs14'][0]; }?></td><?php $PdLvHrs14_total = $PdLvHrs14_total + $searchData3['Hrs14'][0];?><?php $RegHrs14_total = $PdLvHrs14_total + $WkHrs14_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_15" value="<?php echo $searchData3['Hrs15'][0];?>"><?php }else{ echo $searchData3['Hrs15'][0]; }?></td><?php $PdLvHrs15_total = $PdLvHrs15_total + $searchData3['Hrs15'][0];?><?php $RegHrs15_total = $PdLvHrs15_total + $WkHrs15_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_16" value="<?php echo $searchData3['Hrs16'][0];?>"><?php }else{ echo $searchData3['Hrs16'][0]; }?></td><?php $PdLvHrs16_total = $PdLvHrs16_total + $searchData3['Hrs16'][0];?><?php $RegHrs16_total = $PdLvHrs16_total + $WkHrs16_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_17" value="<?php echo $searchData3['Hrs17'][0];?>"><?php }else{ echo $searchData3['Hrs17'][0]; }?></td><?php $PdLvHrs17_total = $PdLvHrs17_total + $searchData3['Hrs17'][0];?><?php $RegHrs17_total = $PdLvHrs17_total + $WkHrs17_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_18" value="<?php echo $searchData3['Hrs18'][0];?>"><?php }else{ echo $searchData3['Hrs18'][0]; }?></td><?php $PdLvHrs18_total = $PdLvHrs18_total + $searchData3['Hrs18'][0];?><?php $RegHrs18_total = $PdLvHrs18_total + $WkHrs18_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_19" value="<?php echo $searchData3['Hrs19'][0];?>"><?php }else{ echo $searchData3['Hrs19'][0]; }?></td><?php $PdLvHrs19_total = $PdLvHrs19_total + $searchData3['Hrs19'][0];?><?php $RegHrs19_total = $PdLvHrs19_total + $WkHrs19_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_20" value="<?php echo $searchData3['Hrs20'][0];?>"><?php }else{ echo $searchData3['Hrs20'][0]; }?></td><?php $PdLvHrs20_total = $PdLvHrs20_total + $searchData3['Hrs20'][0];?><?php $RegHrs20_total = $PdLvHrs20_total + $WkHrs20_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_21" value="<?php echo $searchData3['Hrs21'][0];?>"><?php }else{ echo $searchData3['Hrs21'][0]; }?></td><?php $PdLvHrs21_total = $PdLvHrs21_total + $searchData3['Hrs21'][0];?><?php $RegHrs21_total = $PdLvHrs21_total + $WkHrs21_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_22" value="<?php echo $searchData3['Hrs22'][0];?>"><?php }else{ echo $searchData3['Hrs22'][0]; }?></td><?php $PdLvHrs22_total = $PdLvHrs22_total + $searchData3['Hrs22'][0];?><?php $RegHrs22_total = $PdLvHrs22_total + $WkHrs22_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_23" value="<?php echo $searchData3['Hrs23'][0];?>"><?php }else{ echo $searchData3['Hrs23'][0]; }?></td><?php $PdLvHrs23_total = $PdLvHrs23_total + $searchData3['Hrs23'][0];?><?php $RegHrs23_total = $PdLvHrs23_total + $WkHrs23_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_24" value="<?php echo $searchData3['Hrs24'][0];?>"><?php }else{ echo $searchData3['Hrs24'][0]; }?></td><?php $PdLvHrs24_total = $PdLvHrs24_total + $searchData3['Hrs24'][0];?><?php $RegHrs24_total = $PdLvHrs24_total + $WkHrs24_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_25" value="<?php echo $searchData3['Hrs25'][0];?>"><?php }else{ echo $searchData3['Hrs25'][0]; }?></td><?php $PdLvHrs25_total = $PdLvHrs25_total + $searchData3['Hrs25'][0];?><?php $RegHrs25_total = $PdLvHrs25_total + $WkHrs25_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_26" value="<?php echo $searchData3['Hrs26'][0];?>"><?php }else{ echo $searchData3['Hrs26'][0]; }?></td><?php $PdLvHrs26_total = $PdLvHrs26_total + $searchData3['Hrs26'][0];?><?php $RegHrs26_total = $PdLvHrs26_total + $WkHrs26_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_27" value="<?php echo $searchData3['Hrs27'][0];?>"><?php }else{ echo $searchData3['Hrs27'][0]; }?></td><?php $PdLvHrs27_total = $PdLvHrs27_total + $searchData3['Hrs27'][0];?><?php $RegHrs27_total = $PdLvHrs27_total + $WkHrs27_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_28" value="<?php echo $searchData3['Hrs28'][0];?>"><?php }else{ echo $searchData3['Hrs28'][0]; }?></td><?php $PdLvHrs28_total = $PdLvHrs28_total + $searchData3['Hrs28'][0];?><?php $RegHrs28_total = $PdLvHrs28_total + $WkHrs28_total;?>



									<?php if ($days_in_month > 28) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_29" value="<?php echo $searchData3['Hrs29'][0];?>"><?php }else{ echo $searchData3['Hrs29'][0]; }?></td><?php $PdLvHrs29_total = $PdLvHrs29_total + $searchData3['Hrs29'][0];?><?php $RegHrs29_total = $PdLvHrs29_total + $WkHrs29_total;?>
									<?php } ?>
									<?php if ($days_in_month > 29) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_30" value="<?php echo $searchData3['Hrs30'][0];?>"><?php }else{ echo $searchData3['Hrs30'][0]; }?></td><?php $PdLvHrs30_total = $PdLvHrs30_total + $searchData3['Hrs30'][0];?><?php $RegHrs30_total = $PdLvHrs30_total + $WkHrs30_total;?>
									<?php } ?>
									<?php if ($days_in_month > 30) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if($row_ID == $searchData3['c_cwp_row_ID'][0]){?><input <?php if((($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo 'type="hidden"';}else{echo 'type="text" size="2" class="body"';}?> name="hrs_31" value="<?php echo $searchData3['Hrs31'][0];?>"><?php }else{ echo $searchData3['Hrs31'][0]; }?></td><?php $PdLvHrs31_total = $PdLvHrs31_total + $searchData3['Hrs31'][0];?><?php $RegHrs31_total = $PdLvHrs31_total + $WkHrs31_total;?>
									<?php } ?>
									...
									<td align="center" class="body">
										...
										<a href="/staff/sims/timesheets.php?action=edit&Timesheet_ID=<?php echo $timesheet_ID;?>&edit_row_ID=<?php echo $searchData3['c_cwp_row_ID'][0];?>">Edit</a>
									...
									<?php }else{ ?>
									<td align="center" class="body" colspan="2" bgcolor="#cccccc">
									<?php }?>
									...
									<?php if($searchData3['LvType'][0] != 'Holiday'){?>
										...
										<a href="/staff/sims/timesheet_hrs_delete.php?row_ID=<?php echo $searchData3['c_cwp_row_ID'][0];?>" onclick="return confirmDelete()"><img src="/staff/sims/images/trashcan.jpg" border="0"></a>
...
-->									
	...
	<!--START: SUB-TOTAL PAID LEAVE HRS-->
									...
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs01_total;}?></td><?php $AllHrs01_total = $RegHrs01_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs02_total;}?></td><?php $AllHrs02_total = $RegHrs02_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs03_total;}?></td><?php $AllHrs03_total = $RegHrs03_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs04_total;}?></td><?php $AllHrs04_total = $RegHrs04_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs05_total;}?></td><?php $AllHrs05_total = $RegHrs05_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs06_total;}?></td><?php $AllHrs06_total = $RegHrs06_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs07_total;}?></td><?php $AllHrs07_total = $RegHrs07_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs08_total;}?></td><?php $AllHrs08_total = $RegHrs08_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs09_total;}?></td><?php $AllHrs09_total = $RegHrs09_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs10_total;}?></td><?php $AllHrs10_total = $RegHrs10_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs11_total;}?></td><?php $AllHrs11_total = $RegHrs11_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs12_total;}?></td><?php $AllHrs12_total = $RegHrs12_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs13_total;}?></td><?php $AllHrs13_total = $RegHrs13_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs14_total;}?></td><?php $AllHrs14_total = $RegHrs14_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs15_total;}?></td><?php $AllHrs15_total = $RegHrs15_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs16_total;}?></td><?php $AllHrs16_total = $RegHrs16_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs17_total;}?></td><?php $AllHrs17_total = $RegHrs17_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs18_total;}?></td><?php $AllHrs18_total = $RegHrs18_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs19_total;}?></td><?php $AllHrs19_total = $RegHrs19_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs20_total;}?></td><?php $AllHrs20_total = $RegHrs20_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs21_total;}?></td><?php $AllHrs21_total = $RegHrs21_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs22_total;}?></td><?php $AllHrs22_total = $RegHrs22_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs23_total;}?></td><?php $AllHrs23_total = $RegHrs23_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs24_total;}?></td><?php $AllHrs24_total = $RegHrs24_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs25_total;}?></td><?php $AllHrs25_total = $RegHrs25_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs26_total;}?></td><?php $AllHrs26_total = $RegHrs26_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs27_total;}?></td><?php $AllHrs27_total = $RegHrs27_total;?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs28_total;}?></td><?php $AllHrs28_total = $RegHrs28_total;?>



									<?php if ($days_in_month > 28) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs29_total;}?></td><?php $AllHrs29_total = $RegHrs29_total;?>
									<?php } ?>
									<?php if ($days_in_month > 29) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs30_total;}?></td><?php $AllHrs30_total = $RegHrs30_total;?>
									<?php } ?>
									<?php if ($days_in_month > 30) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $RegHrs31_total;}?></td><?php $AllHrs31_total = $RegHrs31_total;?>
									<?php } ?>
									<td align="center" class="body" colspan="2">&nbsp;</td>
...
<!--BEGIN THIRD SECTION: UNPAID LEAVE HOURS-->
							...
							<?php 
								...
								<?php }else{ ?>
									...
									<td><a href="/staff/sims/timesheet_hrs_delete.php?row_ID=<?php echo $searchData4['c_cwp_row_ID'][0];?>" onclick="return confirmDelete()"><img src="/staff/sims/images/trashcan.jpg" border="0"></a></td>
...
<!--BEGIN FOURTH SECTION: OVERTIME HOURS BY BUDGET CODE-->
							...
							<!--table cellspacing=0 cellpadding=1 border=1 bordercolor="cccccc" width="100%" class="body"-->
									...
									<input type="submit" name="submit" value="Submit"><?php }?></td>
									<td><a href="/staff/sims/timesheet_hrs_delete.php?row_ID=<?php echo $searchData5['c_cwp_row_ID'][0];?>" onclick="return confirmDelete()"><img src="/staff/sims/images/trashcan.jpg" border="0"></a></td>
									</tr>
...
<!--START: GRAND TOTAL HOURS-->
									...
									<td align="center" class="body"><?php $AllHrsT_total = $WkHrsT_total + $PdLvHrsT_total + $UnPdLvHrsT_total + $OTHrsT_total; echo $AllHrsT_total;?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_01']=='Sat')||($_SESSION['day_of_week_01']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs01_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_02']=='Sat')||($_SESSION['day_of_week_02']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs02_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_03']=='Sat')||($_SESSION['day_of_week_03']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs03_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_04']=='Sat')||($_SESSION['day_of_week_04']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs04_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_05']=='Sat')||($_SESSION['day_of_week_05']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs05_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_06']=='Sat')||($_SESSION['day_of_week_06']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs06_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_07']=='Sat')||($_SESSION['day_of_week_07']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs07_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_08']=='Sat')||($_SESSION['day_of_week_08']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs08_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_09']=='Sat')||($_SESSION['day_of_week_09']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs09_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_10']=='Sat')||($_SESSION['day_of_week_10']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs10_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_11']=='Sat')||($_SESSION['day_of_week_11']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs11_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_12']=='Sat')||($_SESSION['day_of_week_12']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs12_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_13']=='Sat')||($_SESSION['day_of_week_13']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs13_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_14']=='Sat')||($_SESSION['day_of_week_14']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs14_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_15']=='Sat')||($_SESSION['day_of_week_15']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs15_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_16']=='Sat')||($_SESSION['day_of_week_16']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs16_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_17']=='Sat')||($_SESSION['day_of_week_17']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs17_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_18']=='Sat')||($_SESSION['day_of_week_18']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs18_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_19']=='Sat')||($_SESSION['day_of_week_19']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs19_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_20']=='Sat')||($_SESSION['day_of_week_20']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs20_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_21']=='Sat')||($_SESSION['day_of_week_21']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs21_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_22']=='Sat')||($_SESSION['day_of_week_22']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs22_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_23']=='Sat')||($_SESSION['day_of_week_23']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs23_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_24']=='Sat')||($_SESSION['day_of_week_24']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs24_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_25']=='Sat')||($_SESSION['day_of_week_25']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs25_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_26']=='Sat')||($_SESSION['day_of_week_26']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs26_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_27']=='Sat')||($_SESSION['day_of_week_27']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs27_total;}?></td>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_28']=='Sat')||($_SESSION['day_of_week_28']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs28_total;}?></td>
									
									
									<?php if ($days_in_month > 28) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_29']=='Sat')||($_SESSION['day_of_week_29']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs29_total;}?></td>
									<?php } ?>
									<?php if ($days_in_month > 29) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_30']=='Sat')||($_SESSION['day_of_week_30']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs30_total;}?></td>
									<?php } ?>
									<?php if ($days_in_month > 30) { ?>
									<td align="center" class="body" <?php if(($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun')){echo 'bgcolor="cccccc"';} ?>><?php if((($_SESSION['day_of_week_31']=='Sat')||($_SESSION['day_of_week_31']=='Sun'))&&($_SESSION['timesheet_prefs_hide_weekends'] == 'Yes')){echo '';}else{echo $AllHrs31_total;}?></td>
									<?php } ?>
									<td align="center" class="body" colspan="2" bgcolor="ffffff"><font color="red">(<?php echo $_SESSION['payperiod_workhrs']; ?>)</font></td>
