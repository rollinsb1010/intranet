...
<!--BEGIN FIRST SECTION: STAFF PROFILE-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr valign="bottom"><td align="right"><font color="666666">Email:</font></td><td><input type="text" name="email" size="30"></td></tr>
...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td align="right"><font color="666666">Program Director:</font></td><td>
								
								
									<select name="pr_dir" class="body">
									<option value="">
									
									<option value="rjarvis"> rjarvis</option>
									</select>
...
<tr><td colspan="3">
			...
			<tr><td colspan="2"><p class="alert_small"><?php if($_SESSION['new_profile_error_code'] !== '0'){echo 'Record Creation Error: '.$_SESSION['new_profile_error_code'];}else{echo 'New record successfully created.';}?></p></td></tr>
...
<!--BEGIN FIRST SECTION: STAFF PROFILE-->
							...
							<tr><td class="body" valign="top" width="50%">
											...
											<tr valign="bottom"><td align="right"><font color="666666">Email:</font></td><td><input type="text" name="email" size="20" value="<?php echo $recordData4['email'][0];?>"></td></tr>
...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td align="right"><font color="666666">Program Director:</font></td><td>
									...
									<option value=""></option>
									<option value="rjarvis" <?php if($recordData4['pr_dir_sims_user_ID'][0] == 'rjarvis'){echo 'SELECTED';}?>> rjarvis</option>
...
<!--BEGIN FIFTH SECTION: EMERGENCY CONTACT INFORMATION-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<font color="#666666">Home: </font> <?php if($recordData4['emerg_contact_prim_phone_hm'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_prim_phone_hm'][0];}?><br>
								<font color="#666666">Work: </font> <?php if($recordData4['emerg_contact_prim_phone_wk'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_prim_phone_wk'][0];}?><br>
								<font color="#666666">Mobile: </font> <?php if($recordData4['emerg_contact_prim_phone_mbl'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_prim_phone_mbl'][0];}?>
...
<!--BEGIN SIXTH SECTION: PLACEHOLDER-->
							...
							<td class="body" valign="top" width="50%">
								...
								<font color="#666666">Home: </font> <?php if($recordData4['emerg_contact_alt_phone_hm'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_alt_phone_hm'][0];}?><br>
								<font color="#666666">Work: </font> <?php if($recordData4['emerg_contact_alt_phone_wk'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_alt_phone_wk'][0];}?><br>
								<font color="#666666">Mobile: </font> <?php if($recordData4['emerg_contact_alt_phone_mbl'][0] == ''){echo 'N/A';}else{echo $recordData4['emerg_contact_alt_phone_mbl'][0];}?>
...
if($mod == '1'){ // STAFF MEMBER UPDATED THEIR WORK HOURS
	$trigger = rand();
	$update_row_ID = $_GET['id'];
...
if($mod == '2'){ // STAFF MEMBER UPDATED THEIR PRIMARY EMERGENCY CONTACT INFORMATION
	#######################################
...
if($mod == '3'){ // STAFF MEMBER UPDATED THEIR ALTERNATE EMERGENCY CONTACT INFORMATION
	#######################################
	## START: GRAB UPDATE FORM VARIABLES ##
	#######################################
	$update_row_ID = $_GET['update_row_ID'];
...
#########################################################################################
## START: NOTIFY ADMIN SERVICES WHEN SOMEONE UPDATES THEIR PRIMARY EMERG. CONTACT INFO ##
#########################################################################################
if($notify_admin_serv == '1'){

	$to = 'sue.liberty@sedl.org';
	$subject = 'Emergency contact information (PRIMARY) has been updated by '.$updatedrecordData['c_full_name_first_last'][0];
	$message = 
	
	'Emergency contact information (PRIMARY) has been updated for SEDL staff member: '.$updatedrecordData['c_full_name_first_last'][0].'.'."\n\n".
...
#######################################################################################
## END: NOTIFY ADMIN SERVICES WHEN SOMEONE UPDATES THEIR PRIMARY EMERG. CONTACT INFO ##
#######################################################################################

###########################################################################################
## START: NOTIFY ADMIN SERVICES WHEN SOMEONE UPDATES THEIR ALTERNATE EMERG. CONTACT INFO ##
###########################################################################################
if($notify_admin_serv == '2'){

	$to = 'sue.liberty@sedl.org';
	$subject = 'Emergency contact information (ALTERNATE) has been updated by '.$updatedrecordData['c_full_name_first_last'][0];
	$message = 
	
	'Emergency contact information (ALTERNATE) has been updated for SEDL staff member: '.$updatedrecordData['c_full_name_first_last'][0].'.'."\n\n".
...
#########################################################################################
## END: NOTIFY ADMIN SERVICES WHEN SOMEONE UPDATES THEIR ALTERNATE EMERG. CONTACT INFO ##
#########################################################################################
...
<!--BEGIN FIRST SECTION: STAFF PROFILE-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr><td valign="top">
										...
										<tr valign="bottom"><td align="right" nowrap><font color="666666">Email/Ext:</font></td><td nowrap><?php echo $recordData4['email'][0];?> / <?php echo $recordData4['phone_ext'][0];?></td></tr>
		
										<tr valign="bottom"><td align="right" nowrap style="vertical-align:text-top"><font color="666666">Work Hrs:</font></td><td nowrap><?php echo $recordData4['staff_work_hours'][0];?> | 

										<span class="tiny"><a href="javascript:toggle1();" id="displayText" title="Click to update your work hours.">Edit</a></span>
										<div id="toggleText" style="display: none; padding:0px">
										<form method="get" name="wk_hrs_form">
										<input type="hidden" name="action" value="show_mine">
										<input type="hidden" name="staff_ID" value="<?php echo $staff_ID;?>">
										<input type="hidden" name="mod" value="1">
										<input type="hidden" name="id" value="<?php echo $recordData4['c_cwp_row_ID'][0];?>">
										<input type="text" name="work_hrs" size="15" value="<?php echo $recordData4['staff_work_hours'][0];?>">
										...
										<tr valign="bottom"><td align="right" nowrap><font color="666666">Suite #:</font></td><td nowrap><?php echo $recordData4['suite_number'][0];?></td></tr>
...
<!--BEGIN FIFTH SECTION: EMERGENCY CONTACT INFORMATION-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr valign="top"><td align="right" nowrap><font color="666666">Primary Contact:</font></td><td nowrap width="100%">
								<div class="tiny" style="float:right"><a href="javascript:toggle2();" id="displayText2" title="Click to update primary emergency contact information.">Edit</a></div>
								<?php echo $recordData4['emerg_contact_prim_name'][0];?> | <?php echo $recordData4['emerg_contact_prim_relation'][0];?><br>
								<?php if($recordData4['emerg_contact_prim_phone_hm'][0] != ''){echo $recordData4['emerg_contact_prim_phone_hm'][0];?> <span class="tiny">HOME</span><br><?php }?>
								<?php if($recordData4['emerg_contact_prim_phone_wk'][0] != ''){echo $recordData4['emerg_contact_prim_phone_wk'][0];?> <span class="tiny">WORK</span><br><?php }?>
								<?php if($recordData4['emerg_contact_prim_phone_mbl'][0] != ''){echo $recordData4['emerg_contact_prim_phone_mbl'][0];?> <span class="tiny">MOBILE</span><?php }?>
								...
								<div id="toggleText2" style="display: none; padding:10px;border:1px dotted #999999;background-color:#fff6bf"><strong>EDIT PRIMARY CONTACT INFORMATION</strong>
								<form style="padding:8px" method="get" name="emerg_cont_form1">
								<input type="hidden" name="action" value="show_mine">
								<input type="hidden" name="staff_ID" value="<?php echo $staff_ID;?>">
								...
								<input type="text" name="emerg_contact_prim_relation" size="20" value="<?php echo $recordData4['emerg_contact_prim_relation'][0];?>"> RELATION<br>
								...
								<input type="text" name="emerg_contact_prim_phone_mbl" size="20" value="<?php echo $recordData4['emerg_contact_prim_phone_mbl'][0];?>"> MOBILE<br>										
								<input type="submit" name="submit" value="Save">
								</form>
								</div>
...
<!--BEGIN SIXTH SECTION: PLACEHOLDER-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="top"><td align="right" nowrap><font color="666666">Alternate Contact:</font></td><td nowrap width="100%">
								<div class="tiny" style="float:right"><a href="javascript:toggle3();" id="displayText3" title="Click to update alternate emergency contact information.">Edit</a></div>
								<?php echo $recordData4['emerg_contact_alt_name'][0];?> | <?php echo $recordData4['emerg_contact_alt_relation'][0];?><br>
								<?php if($recordData4['emerg_contact_alt_phone_hm'][0] != ''){echo $recordData4['emerg_contact_alt_phone_hm'][0];?> <span class="tiny">HOME</span><br><?php }?>
								<?php if($recordData4['emerg_contact_alt_phone_wk'][0] != ''){echo $recordData4['emerg_contact_alt_phone_wk'][0];?> <span class="tiny">WORK</span><br><?php }?>
								<?php if($recordData4['emerg_contact_alt_phone_mbl'][0] != ''){echo $recordData4['emerg_contact_alt_phone_mbl'][0];?> <span class="tiny">MOBILE</span><?php }?>
								...
								<div id="toggleText3" style="display: none; padding:10px;border:1px dotted #999999;background-color:#fff6bf"><strong>EDIT ALTERNATE CONTACT INFORMATION</strong>
								<form style="padding:8px" method="get" name="emerg_cont_form2">
								<input type="hidden" name="action" value="show_mine">
								<input type="hidden" name="staff_ID" value="<?php echo $staff_ID;?>">
								<input type="hidden" name="mod" value="3">
								<input type="hidden" name="update_row_ID" value="<?php echo $recordData4['c_cwp_row_ID'][0];?>">
								<input type="text" name="emerg_contact_alt_name" size="20" value="<?php echo $recordData4['emerg_contact_alt_name'][0];?>"> NAME<br>
								<input type="text" name="emerg_contact_alt_relation" size="20" value="<?php echo $recordData4['emerg_contact_alt_relation'][0];?>"> RELATION<br>
								...
								<input type="text" name="emerg_contact_alt_phone_mbl" size="20" value="<?php echo $recordData4['emerg_contact_alt_phone_mbl'][0];?>"> MOBILE<br>										
								<input type="submit" name="submit" value="Save">
								</form>
								</div>
...
<!--END SIXTH SECTION: PLACEHOLDER-->
							...
							<input type="hidden" name="update_row_ID" value="<?php echo $recordData4['c_cwp_row_ID'][0];?>">
							<input type="submit" name="no_changes" value="No Changes Needed">
							</form>
							</center>
...
$update -> AddDBParam('pr_dir_sims_user_ID',$pr_dir);
...
// GRAB COMMUNICATIONS FIELDS FOR MYSQL REPLACE INTO STATEMENT
			...
			if ($num_rows == '0') {
				...
				(fm_record_id, firstname, middleinitial, lastname, jobtitle, phone, userid, email, phoneext, birthmonth, birthday, timesheetname, department_abbrev, mgmtcouncil, lastupdated, lastupdated_by, room_number, start_date, supervised_by, automated_sentence, photo_permissions, strong_pwd, empl_type, other_SEDL_workgroup, immediate_supervisor_sims_user_ID, bgt_auth_primary_sims_user_ID, time_leave_admin_sims_user_ID)
				VALUES ('$update_row_ID', '$first_name', '$middle_initial', '$last_name', '$title', '$phone', '$sims_user_ID', '$email', '$ext', '$birthmonth', '$birthday', '$timesheet_name', '$sedl_unit', '$on_mgmt_council', '$last_updated', '$last_updated_by', '$ste_num', '$start_date_mysql', '$imm_spvsr', '', 'Needed', '$strong_pwd', '$empl_type', '$other_SEDL_workgroup', '$immediate_supervisor_sims_user_ID', '$bgt_auth_primary_sims_user_ID', '$time_leave_admin_sims_user_ID')";
...
############################################################################################################################################################################################################################################################
############################################################################################################################################################################################################################################################
} elseif ($action == 'update_emerg_info') { // STAFF MEMBER UPDATED THEIR EMERGENCY INFO
...
$newrecord -> AddDBParam('pr_dir_sims_user_ID',$pr_dir);
...
$newrecord -> AddDBParam('personnel_action_admin_sims_user_ID',$time_leave_admin);
...
################################
$_SESSION['new_profile_error_code'] = $newrecordResult['errorCode'];
#################################################################################################
## START: DISPLAY THE STAFF PROFILE RECORDS IN LIST VIEW
#################################################################################################
...
############################################################################################################################################################################################################################################################
############################################################################################################################################################################################################################################################
 } elseif ($action == 'cp') { // CHANGE PASSWORD
