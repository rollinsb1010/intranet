...
$search2 -> AddDBParam('c_bgt_code_reports_matchkey',$_SESSION['user_ID']);
...
$search3 -> AddDBParam('immediate_supervisor_sims_user_ID',$_SESSION['user_ID']);
...
<tr><td colspan="3">
			...
			<tr><td height="33" colspan="2" scope="row"><h1>SIMS - <?php echo $_SESSION['workgroup'];?> Budget Code Reports</h1><hr /></td></tr>
...
<hr>
											...
											<table cellspacing="0" cellpadding="5" border="0" width="100%">
											<tr><td colspan="2"><strong>Staff Time Summary by Budget Code:</strong></td></tr>
...
#################################
$rand = rand();
$xml_header = "<chart caption='SEDL Budget Code Monthly Summary: $begin_date - $end_date' subcaption='Budget Code $budget_code' xAxisName='Month' yAxisName='Hours Charged' numberPrefix=''>
";
//$file_name = "bgt_cd_summary_ba.xml";
$file_name = 'bgt_cd_summary_ba.xml';
...
$staff_col_unique_colspan = count($staff_col_unique);
...
## START: WRITE CHART XML FILE ##
#################################
$xml_header = "<chart caption='SEDL Budget Code Summary: $begin_date - $end_date' subcaption='Budget Code $budget_code' xAxisName='Staff Member' yAxisName='Hours Charged' numberPrefix='' labelDisplay='Rotate' slantLabels='1' rotateValues='1' placeValuesInside='1'>
";
//$file_name = "bgt_cd_summary_ba.xml";
$file_name = 'bgt_cd_summary_ba.xml';
...
<?php $_SESSION['budget_code_deleted'] = ''; }?>
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong>Budget Code Summary Report: <?php echo $searchResult['foundCount'];?></strong> records found.</td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="bgt_code_report_spvsr.php?action=new">New Report</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
...
<?php //}?>							  	
							...
							Hours charged to budget code <strong><?php echo $budget_code;?></strong> from <strong><?php echo $begin_date;?></strong> to <strong><?php echo $end_date;?></strong> | <a href="bgt_code_report_spvsr.php?action=run_bgt_cd_sum_chart&begin_date=<?php echo $begin_date;?>&end_date=<?php echo $end_date;?>&budget_code=<?php echo $budget_code;?>" target="_blank">Show monthly summary chart</a></td></tr>
							<tr>
...
<?php $_SESSION['budget_code_deleted'] = ''; }?>
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong>Staff Time Summary by Budget Code: <?php echo $searchResult['foundCount'];?> records found.</td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="bgt_code_report_spvsr.php?action=new">New Report</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
