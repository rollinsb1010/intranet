...
function checkFields() { 
	...
	// Phone
		if (document.new_employee.phone.value ==""){
			alert("Field missing: Phone");
			document.new_employee.phone.focus();
			return false;	}
	...
	// Birthmonth
		if (document.new_employee.birthmonth.value ==""){
			alert("Field missing: Birth Month");
			document.new_employee.birthmonth.focus();
			return false;	}

	// Birthday
		if (document.new_employee.birthday.value ==""){
			alert("Field missing: Birth Day");
			document.new_employee.birthday.focus();
			return false;	}
...
<!--BEGIN FIRST SECTION: STAFF PROFILE-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr valign="bottom"><td align="right"><font color="666666">Work Hrs/Ste#:</font></td><td><input type="text" name="work_hrs" size="20"><input type="text" name="ste_num" size="5"></td></tr>
...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td align="right"><font color="666666">Supervisor:</font></td><td>
									...
									<option value="<?php echo $searchData['sims_user_ID'][0];?>"> <?php echo $searchData['sims_user_ID'][0];?>
									<?php } ?>
									</select>
...
<!--BEGIN THIRD SECTION: SIMS/INTRANET PREFERENCES-->
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr valign="bottom"><td align="right"><font color="666666">SIMS ID:</font></td><td><input type="text" name="sims_user_ID" size="12"> 
								...
								<input type="checkbox" name="sims_access_admin_serv" value="Yes"> Admin. Svcs. admin<br>
								<input type="checkbox" name="sims_access_travel_forms" value="Yes"> Travel forms<br>
								...
								<input type="checkbox" name="sims_access_staff_profiles" value="Yes"> Staff profiles<br>
...
$search4 -> AddDBParam('staff_ID','=='.$_SESSION['staff_ID']);
...
<tr><td colspan="3">
			...
			<tr bgcolor="#e2eaa4"><td class="body"><strong><?php echo stripslashes($recordData4['staff::c_full_name_last_first'][0]);?> - <?php echo $recordData4['staff::primary_SEDL_workgroup'][0];?></strong></td><td align="right">Current user: <?php echo $_SESSION['user_ID'];?> | <a href="staff_pos_descr.php?action=show_mine&staff_ID=<?php echo $recordData4['staff_ID'][0];?>"">Show All</a> | <a href="sims_menu.php?src=intr">SIMS Home</a></td></tr>
			
			
			
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: If changes are needed to your position description, contact your admin assistant or budget authority. | Last updated: <?php echo $recordData4['last_mod_timestamp'][0];?></p></td></tr>
...
<!--BEGIN FIRST SECTION: POSITION INFORMATION-->
							...
							<tr><td class="body" valign="top" width="100%">
										...
										<table cellspacing="0" cellpadding="5" border="0" width="100%">
											...
											<tr><td><strong>POSITION TITLE:</strong> <?php echo $recordData4['PositionTitle'][0];?></td><td align="right"><strong>DATE PREPARED/REVISED:</strong> <?php echo $recordData4['DatePreparedRevised'][0];?></td></tr>
											...
											<tr><td><strong>REPORTS DIRECTLY TO:</strong> <?php echo $recordData4['staff_SJ_by_imm_spvsr::c_full_name_first_last'][0];?></td><td align="right"><strong>Position incumbent is required to supervise other staff:</strong> <?php echo $recordData4['SupervisionRequired'][0];?></td></tr>
...
if(strpos($recordData4['c_pos_descr_access_list'][0],$_SESSION['user_ID'])!== false){
$allow_admin = '1';
}
...
<tr><td colspan="3">
			...
			<tr><td class="body" colspan="2"><p class="info_small"><span class="tiny">NOTE: If changes are needed to your position description, contact your admin assistant or budget authority. | Last updated: <?php echo $recordData4['last_mod_timestamp'][0];?>
			</p></td></tr>
...
<?php $_SESSION['new_pd_created'] = ''; } ?>
							...
							<tr><td class="body" valign="top" width="50%">
								...
								<tr><td valign="top">
										...
										<table cellspacing="0" cellpadding="5" border="0" width="100%">
										<tr valign="bottom"><td><img src="http://www.sedl.org/images/people/<?php echo $_SESSION['user_ID'];?>.jpg"><p>
											<a href="http://www.sedl.org/staff/personnel/staffprofiles.cgi?intranetonly=yes&showuserid=<?php echo $_SESSION['user_ID'];?>" target="_blank">Private profile</a><br>
											<a href="http://www.sedl.org/pubs/catalog/authors/<?php echo $_SESSION['user_ID'];?>.html" target="_blank">Public profile</a></td></tr>
...
<!--BEGIN SECOND SECTION: TIMESHEET INFORMATION-->
							...
							<td class="body" valign="top" width="50%">
								...
								<tr valign="middle"><td colspan="2"><font color="666666">The following are live links to your position descriptions. Use the links in the first column - Intranet version - to view and/or print an informal copy 
								for your records. To view and/or print a formal copy, use the links in the second column - Filemaker version. </font>
								...
								<tr valign="top"><td align="right" nowrap><font color="666666" nowrap>Form(s):</font></td><td>
										...
										<?php foreach($searchResult5['data'] as $key => $searchData5) { ?>
												<tr><td><a href="staff_pos_descr.php?action=show_1&pos_descr_ID=<?php echo $searchData5['RecordID'][0];?>"><?php echo $searchData5['c_date_prepared_display'][0];?></a></td><td><a href="sims_temp_launcher<?php if($allow_admin == '1'){ ?>_admin<?php }?>.php?object_ID=<?php echo $searchData5['RecordID'][0];?>&target=pos_descr" target="_blank"><?php echo $searchData5['c_date_prepared_display'][0];?></a></td></tr>
										<?php } ?>
<tr><td colspan="2"><span class="tiny">*If you have trouble opening the FileMaker version, contact <a href="mailto:sims@sedl.org">sims@sedl.org</a></span></td></tr>		
										</table>

								</td></tr>
								

<?php if($allow_admin == '1'){ ?>

								<tr><td colspan="2"><font color="#666666">In addition to viewing your existing position descriptions above, you can also create a new position description for yourself based on your most recent PD on file. To create a new (duplicated) position description, open your most recent position description listed above, then select "Create Duplicate Document" from the File menu.<p>
								To create a new blank position description for yourself, <a href="sims_new_pd_admin.php?staff_ID=<?php echo $recordData4['staff_ID'][0];?>&src=staff">click here</a>. Then view or edit the newly created PD by clicking the new link above.
											</td></tr>
