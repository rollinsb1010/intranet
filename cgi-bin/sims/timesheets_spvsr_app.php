...
echo '<br>$_SESSION[employee_type_owner]: '.$_SESSION['employee_type_owner'];

echo '<br>$_SESSION[current_submitted_status]: '.$_SESSION['current_submitted_status'];
}
...
###############################################################################
include_once('timesheets_view_spvsr.php'); //modularized the standard timesheet view used by staff
#############################################################################
