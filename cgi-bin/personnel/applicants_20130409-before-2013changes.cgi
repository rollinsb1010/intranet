...
<P>
		...
		<TR><TD bgcolor="#EBEBEB"><strong>Street Address</strong></td>
			...
			<TD bgcolor="#EBEBEB"><strong>E-mail Address</strong></TD></TR>
...
<P>
<strong>Do you understand that if employed by SEDL, you will be required to work during SEDL's normal
business hours (e.g., 8:00 am - 5:00 pm, Monday through Friday) and such other hours as may be
required by your position or assigned by your supervisor?</strong><br>
	<UL>
	$understand_hrs
EOM
...
<P>
<strong>Do you understand that if employed by SEDL, you may be required to work beyond SEDL's normal
business hours if requested by your supervisor or necessitated by temporary circumstances? (Note:
Such work performed by a staff member in a nonexempt position would be compensated, while in
exempt positions it would be uncompensated.)</strong><BR>
	<UL>
...
<P>
<strong>If the position for which you are applying involves travel (including, but not limited to, commercial
airline travel), are you willing to perform fully those duties and travel as required by the position,
even if outside SEDL's normal business hours?</strong><BR>
	<UL>
	$understand_travel
EOM
...
<P>
<strong>Has any court ever received a plea of guilty or a plea of nolo contendre from you for any offense dealing with moral turpitude, deferred further proceedings without entering a finding of guilty, and/or placed you on probation?</strong>
	<UL>
	$nolo_contendre
EOM
	if ($nolo_contendre eq 'yes') {
print<<EOM;
	<P>
	<em>If Yes, please explain:</em><BR>
	$nolo_contendre_explain
EOM
	}
print<<EOM;
	</UL>
<P>
Note: Conviction of a crime is not an automatic bar to employment. SEDL will consider the nature of the offense, the date of the offense, and the relationship between the offense and the position for which you are applying.
</P>
...
print<<EOM;
<P>
<strong>Can you operate a word processor (e.g., personal computer)?</strong>
	<UL>
	$word_processor
	<P>
	<em>Types:</em> $word_processor_types
	</UL>
EOM
...
I declare that, to the best of my knowledge and belief, all of the information that I have provided in this Application for Employment with SEDL is true, correct, and complete.
	<ul>
	<em>$name_f 
EOM
...
<TR bgcolor="#ebebeb">
	...
	<td><strong>Phone/ E-mail</strong></td>
