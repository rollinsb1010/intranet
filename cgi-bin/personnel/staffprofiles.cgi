...
if ($debug eq '1') {
	...
	open (STAFFROOMSARRAY,">/home/httpd/html/staff/personnel/sedlstaff-roomnumbers-array.txt");
...
EOM
	...
	## QUERY STAFF PROFILES DB FOR OTHER EMAIL ADDRESSES
	my $command = "select firstname, lastname, phone, userid, email, phoneext, department_abbrev, room_number from staff_profiles where 
					firstname NOT LIKE '' 
...
#			my ($fm_record_id, $firstname, $middleinitial, $lastname, $jobtitle, $phone, $userid, $email, $phoneext, $birthmonth, $birthday, $timesheetname, $department_abbrev, $responsibilities, $experience, $mgmtcouncil, $lastupdated, $lastupdated_by, $room_number, $start_date, $adjusted_start_date, $stafflistsorting, $supervised_by, $automated_sentence, $photo_permissions, $show_birthday, $external_publications, $strong_pwd, $empl_type, $degree, $is_bgt_auth, $is_auth_rep) = @arr;
			my ($firstname, $lastname, $phone, $userid, $email, $phoneext, $department_abbrev, $room_number) = @arr;
...
";
			...
			print STAFFROOMSARRAY "$firstname\t$lastname\t$room_number\t$department_abbrev\n";
		} # END DB QUERY LOOP
	close (VCF);
	close (NICKNAMES);
	close (STAFFARRAY);
	close (STAFFROOMSARRAY);
#	close (STAFFARRAY_BA);
...
my @departmentlist = (
	...
	"Education Systems Support (ESS) program",
...
my @departmentlistwithlink = (
	"Executive Office", 
	"Administrative Services department", 
	"Afterschool, Family, and Community program<br>
		<span style=\"font-size:14px;\">Projects under this program include:</span>
		<ul style=\"margin-top:0;margin-bottom:4px;\">
		<li style=\"color:#bf7908;\"><a href=\"http://www.sedl.org/connections/\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">National Center for Family and Community Connections with Schools</span></a></li>
		<li style=\"color:#bf7908;\"><a href=\"/afterschool/\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\" style=\"color:#bf7908;\">National Center for Quality Afterschool</span></a></li>
		</ul>
		", 
	"Communications department", 
	"Development department",
	"Disability Research to Practice (DRP) program<br>
		<span style=\"font-size:14px;\">Projects under this program include:</span>
		<ul style=\"margin-top:0;margin-bottom:4px;\">
		<li style=\"color:#bf7908;\"><a href=\"http://www.kter.org/\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Center on Knowledge Translation for Employment Research</span></a> (KTER Center)</li>
		<li style=\"color:#bf7908;\"><a href=\"http://www.ktdrr.org\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Knowledge Translation for Disability and Rehabilitation Research Center</span></a> (KTDRR)</li>
		<li style=\"color:#bf7908;\"><a href=\"http://autism.sedl.org/\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Vocational Rehabilitation Service Models for Individuals with Autism Spectrum Disorders</span></a></li>
		<li style=\"color:#bf7908;margin-bottom:0;\"><span style=\"color:#bf7908;\">Southwest ADA Center Research project</li>
		</ul>",
	"Education Systems Support (ESS) program<br>
		<span style=\"font-size:14px;\">Projects under this program include:</span>
		<ul style=\"margin-top:0;margin-bottom:4px;\">
		<li style=\"color:#bf7908;\"><a href=\"http://secc.sedl.org\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Southeast Comprehensive Center</span></a> (SECC)</li>
		<li style=\"color:#bf7908;margin-bottom:0;\"><a href=\"http://txcc.sedl.org\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Texas Comprehensive Center</span></a> (TXCC)</li>
		</ul>",
	"Regional Educational Laboratory (REL)<br>
		<span style=\"font-size:14px;\">Projects under this program include:</span>
		<ul style=\"margin-top:0;margin-bottom:4px;\">
		<li style=\"color:#bf7908;\"><span style=\"color:#bf7908;\"><a href=\"http://rel-se.fcrr.org\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">REL Southeast</span></a></li>
		<li style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">REL Southwest</span></li>
		</ul>",
	"<a href=\"/re/\" style=\"color:#bf7908;\"><span style=\"color:#bf7908;\">Research and Evaluation (R&E)</span></a><br>
		<span style=\"font-size:14px;\">Projects under this program include:</span>
		<ul style=\"margin-top:0;margin-bottom:4px;\">
		<li style=\"color:#bf7908;\"><a href=\"http://research.sedl.org/ocr-em/\" style=\"color:#bf7908;\" title=\"SRA Imagine It! and Everyday Mathematics RCT\"><span style=\"color:#bf7908;\">SRA Imagine It! Today's Open Court RCT</span></a></li>
		<li style=\"color:#bf7908;margin-bottom:0;\"><a href=\"http://research.sedl.org/ocr-em/\" style=\"color:#bf7908;\" title=\"SRA Imagine It! and Everyday Mathematics RCT\"><span style=\"color:#bf7908;\">Everyday Mathematics RCT</span></a></li>
		</ul>"
		);


my @departmentpagereference = ("EO", "AS", "AFC", "COM", "DEV", "DRP", "ESS", "REL", "R&E");
...
$pre_sidenav
  ...
  <p class="tocheader2">Our People</p>
   <div id="nav2">
   <ul class="level1">
      	<li class="submenu"><a href="/about/board.html">Board of Directors</a></li>
		<li class="submenu"><a href="/about/management.html">Management Team</a></li>
		<li class="submenu active"><a href="/about/staff.html">Staff</a></li>
		<li class="submenu submenubullet"><a href="/about/presidents-awards.html">President's Awards</a></li>
...
<div id="mainContentPadding">
	<p id="breadcrumbs" role="navigation">
		<a href="/" title="SEDL Home" class="crumb">Home</a> | <a href="/about/" class="crumb">About Us</a> | <a href="/about/staff.html" class="crumb">Staff Directory</a> | By Department
	</p>
...
<p></p>
<table border="0" cellpadding="4" cellspacing="0" width="100%" class="table_row_odd_color color_border_bottom" summary="This table is a list of SEDL staff members">
EOM
...
print LISTBYDEPARTMENT <<EOM;
              <tr style="background-color: #ffffff"><td colspan="4"> <a name="$department_name_ref"></a><h2 style="margin-bottom:0;">$department_name</h2></td></tr>
EOM
	} else {
print LISTBYDEPARTMENT <<EOM;
              <tr style="background-color: #ffffff"><td colspan="4" class="color_border_top"> <a name="$department_name_ref"></a><h2 style="margin-bottom:0;">$department_name</h2></td></tr>
EOM
	}
print LISTBYDEPARTMENT <<EOM;
...
print LISTBYDEPARTMENT <<EOM;
<tr> 
	<td valign="top" class="table_row_odd_color color_border_left"><a href="/pubs/catalog/authors/lwood.html">Wood, Lacy</a></td>
	<td valign="top" class="table_row_odd_color">Project Director</td>
	<td valign="top" class="table_row_odd_color color_border_right">512-391-6567</td></tr>
EOM
}
			...
			## START: HANDLE ISP to ESS change
			if ($departmentpagereference[$loopingdepartments] eq 'ESS') {
				$command = "select * from staff_profiles 
				where ((department_abbrev LIKE 'ESS') OR (department_abbrev LIKE 'ISP')) 
				AND firstname NOT LIKE '' 
				AND start_date <= '$date_full_mysql'
				order by mgmtcouncil DESC, stafflistsorting DESC, lastname";
			} # END IF
			## END: HANDLE ISP to ESS change
#			print "<P>COMMAND: $command<P>";
			...
			$sth->execute;
			my $num_matches = $sth->rows;
			my $bgcolor_alternating = "table_row_even_color";
				if ($department_name =~ 'Family') {
					$bgcolor_alternating = "table_row_odd_color";
				} # END IF
				################################################################
				...
				while (my @arr = $sth->fetchrow) {
    				$count++;
 					my ($fm_record_id, $firstname, $middleinitial, $lastname, $jobtitle, $phone, $userid, $email, $phoneext, $birthmonth, $birthday, $timesheetname, $department_abbrev, $responsibilities, $experience, $mgmtcouncil, $lastupdated, $lastupdated_by, $room_number, $start_date, $adjusted_start_date, $stafflistsorting, $supervised_by, $automated_sentence, $photo_permissions, $show_birthday, $external_publications, $strong_pwd, $empl_type, $degree, $is_bgt_auth, $is_auth_rep) = @arr;
						...
						if ($bgcolor_alternating eq "table_row_odd_color") {
							$bgcolor_alternating = "table_row_even_color";
						} else {
							$bgcolor_alternating = "table_row_odd_color";
						}
...
print LISTBYDEPARTMENT <<EOM;
<tr> 
	<td valign="top" class="$bgcolor_alternating color_border_left"><a href="/pubs/catalog/authors/$userid.html">$boldingtag$lastname, $firstname$boldingtagclose</a></td>
	<td valign="top" class="$bgcolor_alternating">$jobtitle</td>
	<td valign="top" class="$bgcolor_alternating color_border_right
EOM
	print LISTBYDEPARTMENT " noWrap" if ($phonenumber !~ 'and');
...
$post_centerpiece
			<!-- ************************************** -->
			<!-- start div "bannerad_right1" -->
			<!-- ************************************** -->
			<div id="bannerad_right1">
				<img src="/common/images/corp/bannerad-corner.png" class="banneradicon" alt="">
				<h3 style="margin-bottom:6px;">Current Career Opportunities</h3>
				<!--#include virtual="/about/careers.cgi?location=list_openings&amp;sidemenu=yes" -->
			</div>
			<!-- ************************************** -->
			<!-- end div "bannerad_right1" -->
			<!-- ************************************** -->
$footer
EOM
...
<div id="mainContentPadding">
	<p id="breadcrumbs" role="navigation">
		<a href="/" title="SEDL Home" class="crumb">Home</a> | <a href="/about/" class="crumb">About Us</a> | <a href="/about/staff.html" class="crumb">Staff Directory</a> | By Last Name of Staff
	</p>
...
<table border="0" cellpadding="4" cellspacing="0" width="100%" class="table-staff color_border_bottom" summary="This table is a list of SEDL staff members">
<tr class="table_header">
	<th style="text-align:left;"><strong>Staff Member</strong></th>
	<th style="text-align:left;"><strong>Title</strong></th>
...
<tr> 
	...
	<td valign="top" class="$bgcolor_alternating color_border_right
EOM
	print LISTBYLASTNAME " noWrap" if ($phonenumber !~ 'and');
$phonenumber =~ s/and/and\<br\>/gi;
print LISTBYLASTNAME <<EOM;
">$phonenumber</td>
</tr>
...
my $laststatus = "0";
	while (my @arr = $sth->fetchrow) {
    	$count++;
		my ($fm_record_id, $firstname, $middleinitial, $lastname, $jobtitle, $phone, $userid, $email, $phoneext, $birthmonth, $birthday, $timesheetname, $department_abbrev, $responsibilities, $experience, $mgmtcouncil, $lastupdated, $lastupdated_by, $room_number, $start_date, $adjusted_start_date, $stafflistsorting, $supervised_by, $automated_sentence, $photo_permissions, $show_birthday, $external_publications, $strong_pwd, $empl_type, $degree, $is_bgt_auth, $is_auth_rep) = @arr;
		$experience =~ s/light-blue\.gif/light-blue\.png/gi;
		my $department_fullname = &abbr_to_department_name($department_abbrev);
		$counter_staff++;
...
print STAFFPROFILEPAGE<<EOM;
<link rel="image_src" href="http://www.sedl.org/images/people/$userid.jpg" >
EOM
	}
print STAFFPROFILEPAGE<<EOM;
<!-- This page was autogenerated by the staff_profiles database on $date_full_pretty_4digityear_withtime.  See the webmaster for more details. -->
...
<div id="mainContentPadding">
	<p id="breadcrumbs" role="navigation">
		<a href="/" title="SEDL Home" class="crumb">Home</a> | <a href="/about/" class="crumb">About Us</a> | <a href="/about/staff.html" class="crumb">Staff Directory</a> | $firstname $middleinitial $lastname
	</p>
...
if ((lc($photo_permissions) eq 'on file') && ($staff_image_onfile{$userid} eq "yes")) {
	...
	print STAFFPROFILEPAGE "<IMG SRC=\"/images/people/$userid.jpg\" ALT=\"Photo of $firstname $middleinitial $lastname\" class=\"fltrt oneBorder\" style=\"margin: 0 0 0 12px;\">";
}
	##########################################
...
#					$title_noquotes .= " ($datepub)" if $datepub ne '';
			...
			print STAFFPROFILEPAGE "<a name=\"pubs\"></a>\n<p></p>\n<strong>SEDL Publications</strong>\n<ul style=\"list-style-image: url(http://www.sedl.org/images/bullets/light-blue.png);margin-top:0px;\">\n" if $count eq '1';
			...
			my $visual_clue_availablehow = "";
				...
				if ($isactive =~ 'n-profilepub') {
					...
					if (($title =~ 'SEDL Letter') || ($title =~ 'SEDLetter')) {
						...
						";
						my $dsn = "DBI:mysql:database=publications;host=www.sedl.org";
...
<p>
You may view the staff list sorted by <a href=\"staffprofiles.cgi?amp;id=all&amp;list_view=birthday\">Birthday</a> 
...
EOM
print "<br><a href=\"http://www.sedl.org/staff/planning/vita_upload.cgi\"><span style=\"color:#666666\" title=\"Your vita (that you do for Development for use in proposals) is different than your online staff profile (that you update with Communications for the website).\">Vita updated: $vita_last_updated{$userid}</span></a>" if ($vita_last_updated{$userid} ne '');
print<<EOM;
	</td>
...
my $dept_name = $_[0];
		...
		$dept_name = "Education Systems Support program" if (($dept_name eq 'Education Systems Support program') || ($dept_name eq 'Improving School Performance program'));
	return($dept_name);
}
...
my $article = "a";
	...
	$article = "an" if $this_job_title eq 'Information Technology Manager';
...
#################################################################
## START SUBROUTINE: do_encryption (for email addresses)
#################################################################
sub do_encryption {
...
sub abbr_to_department_name {
	...
	my $dept_name = "(missing department name)";
	   $dept_name = "Afterschool, Family, and Community (AFC) program" if ($dept_abbr eq "AFC");
	   ...
	   $dept_name = "Disability Research to Practice (DRP) program" if ($dept_abbr eq "DRP");
	   $dept_name = "Education Systems Support (ESS) program" if (($dept_abbr eq "ESS") || ($dept_abbr eq "ISP"));
	   $dept_name = "Regional Educational Laboratory (REL) program" if ($dept_abbr eq 'REL');
